...
namespace LitJson {
  ...
  class JsonException : public ::System::Exception {
    ...
    // System.Void .ctor(LitJson.ParserToken token, System.Exception inner)
    // Offset: 0x11FAD08
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static JsonException* New_ctor(::LitJson::ParserToken token, ::System::Exception* inner) {
      static auto ___internal__logger = ::Logger::get().WithContext("::LitJson::JsonException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<JsonException*, creationType>(token, inner)));
    }
    ...
    // System.Void .ctor(System.Int32 c, System.Exception inner)
    // Offset: 0x11FAE88
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static JsonException* New_ctor(int c, ::System::Exception* inner) {
      static auto ___internal__logger = ::Logger::get().WithContext("::LitJson::JsonException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<JsonException*, creationType>(c, inner)));
    }
    ...
    // Offset: 0x11FAFC8
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static JsonException* New_ctor(::StringW message, ::System::Exception* inner) {
      static auto ___internal__logger = ::Logger::get().WithContext("::LitJson::JsonException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<JsonException*, creationType>(message, inner)));
    }
