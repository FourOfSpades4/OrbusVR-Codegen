...
namespace LitJson {
  ...
  struct JsonType/*, public ::System::Enum*/ {
    ...
    // static field const value: static public LitJson.JsonType Natural
    static constexpr const int Natural = 4;
    // Get static field: static public LitJson.JsonType Natural
    static ::LitJson::JsonType _get_Natural();
    // Set static field: static public LitJson.JsonType Natural
    static void _set_Natural(::LitJson::JsonType value);
    // static field const value: static public LitJson.JsonType Real
    static constexpr const int Real = 5;
    // Get static field: static public LitJson.JsonType Real
    static ::LitJson::JsonType _get_Real();
    // Set static field: static public LitJson.JsonType Real
    static void _set_Real(::LitJson::JsonType value);
