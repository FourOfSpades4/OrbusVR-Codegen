...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::LitJson::JsonMapper::$$c__DisplayClass34_0_1, "LitJson", "JsonMapper/<>c__DisplayClass34_0`1");
// Type namespace: LitJson
namespace LitJson {
  // WARNING Size may be invalid!
  // Autogenerated type: LitJson.JsonMapper/<>c__DisplayClass34_0`1
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: ACEBA0
  template<typename T>
  class JsonMapper::$$c__DisplayClass34_0_1 : public ::Il2CppObject {
    public:
    public:
    ...
    [[deprecated("Use field access instead!")]] ::LitJson::ExporterFunc_1<T>*& dyn_exporter() {
      static auto ___internal__logger = ::Logger::get().WithContext("::LitJson::JsonMapper::$$c__DisplayClass34_0_1::dyn_exporter");
    ...
    static JsonMapper::$$c__DisplayClass34_0_1<T>* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::LitJson::JsonMapper::$$c__DisplayClass34_0_1::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<JsonMapper::$$c__DisplayClass34_0_1<T>*, creationType>()));
    }
    ...
    void $RegisterExporter$b__0(::Il2CppObject* obj, ::LitJson::JsonWriter* writer) {
      static auto ___internal__logger = ::Logger::get().WithContext("::LitJson::JsonMapper::$$c__DisplayClass34_0_1::<RegisterExporter>b__0");
  ...
  }; // LitJson.JsonMapper/<>c__DisplayClass34_0`1
  // Could not write size check! Type: LitJson.JsonMapper/<>c__DisplayClass34_0`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
