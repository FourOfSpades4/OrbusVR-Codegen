...
namespace LitJson {
  ...
  struct JsonToken/*, public ::System::Enum*/ {
    ...
    static constexpr const int PropertyName = 3;
    ...
    static constexpr const int ArrayEnd = 6;
    ...
    // static field const value: static public LitJson.JsonToken Real
    static constexpr const int Real = 7;
    // Get static field: static public LitJson.JsonToken Real
    static ::LitJson::JsonToken _get_Real();
    // Set static field: static public LitJson.JsonToken Real
    static void _set_Real(::LitJson::JsonToken value);
    // static field const value: static public LitJson.JsonToken Natural
    static constexpr const int Natural = 8;
    // Get static field: static public LitJson.JsonToken Natural
    static ::LitJson::JsonToken _get_Natural();
    // Set static field: static public LitJson.JsonToken Natural
    static void _set_Natural(::LitJson::JsonToken value);
