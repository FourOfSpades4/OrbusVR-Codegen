...
namespace Valve::VR {
  ...
  struct EVRInitError/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Valve.VR.EVRInitError Init_VRWebHelperStartupFailed
    ...
    static ::Valve::VR::EVRInitError _get_Init_VRWebHelperStartupFailed();
    // Set static field: static public Valve.VR.EVRInitError Init_VRWebHelperStartupFailed
    static void _set_Init_VRWebHelperStartupFailed(::Valve::VR::EVRInitError value);
    // static field const value: static public Valve.VR.EVRInitError Init_TrackerManagerInitFailed
    ...
    static ::Valve::VR::EVRInitError _get_Init_TrackerManagerInitFailed();
    // Set static field: static public Valve.VR.EVRInitError Init_TrackerManagerInitFailed
    static void _set_Init_TrackerManagerInitFailed(::Valve::VR::EVRInitError value);
