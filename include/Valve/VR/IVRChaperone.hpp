...
namespace Valve::VR {
  ...
  struct IVRChaperone/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: Valve.VR.IVRChaperone/_GetCalibrationState GetCalibrationState
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRChaperone::_GetCalibrationState*& dyn_GetCalibrationState();
    // Get instance field reference: Valve.VR.IVRChaperone/_GetPlayAreaSize GetPlayAreaSize
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRChaperone::_GetPlayAreaSize*& dyn_GetPlayAreaSize();
    // Get instance field reference: Valve.VR.IVRChaperone/_GetPlayAreaRect GetPlayAreaRect
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRChaperone::_GetPlayAreaRect*& dyn_GetPlayAreaRect();
    // Get instance field reference: Valve.VR.IVRChaperone/_ReloadInfo ReloadInfo
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRChaperone::_ReloadInfo*& dyn_ReloadInfo();
    // Get instance field reference: Valve.VR.IVRChaperone/_SetSceneColor SetSceneColor
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRChaperone::_SetSceneColor*& dyn_SetSceneColor();
    // Get instance field reference: Valve.VR.IVRChaperone/_GetBoundsColor GetBoundsColor
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRChaperone::_GetBoundsColor*& dyn_GetBoundsColor();
    // Get instance field reference: Valve.VR.IVRChaperone/_AreBoundsVisible AreBoundsVisible
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRChaperone::_AreBoundsVisible*& dyn_AreBoundsVisible();
    // Get instance field reference: Valve.VR.IVRChaperone/_ForceBoundsVisible ForceBoundsVisible
