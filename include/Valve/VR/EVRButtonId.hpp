...
namespace Valve::VR {
  ...
  struct EVRButtonId/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Valve.VR.EVRButtonId k_EButton_Knuckles_A
    ...
    static ::Valve::VR::EVRButtonId _get_k_EButton_Knuckles_A();
    // Set static field: static public Valve.VR.EVRButtonId k_EButton_Knuckles_A
    static void _set_k_EButton_Knuckles_A(::Valve::VR::EVRButtonId value);
    // static field const value: static public Valve.VR.EVRButtonId k_EButton_Knuckles_B
    ...
    static ::Valve::VR::EVRButtonId _get_k_EButton_Knuckles_B();
    // Set static field: static public Valve.VR.EVRButtonId k_EButton_Knuckles_B
    static void _set_k_EButton_Knuckles_B(::Valve::VR::EVRButtonId value);
    // static field const value: static public Valve.VR.EVRButtonId k_EButton_Knuckles_JoyStick
    ...
    static ::Valve::VR::EVRButtonId _get_k_EButton_Knuckles_JoyStick();
    // Set static field: static public Valve.VR.EVRButtonId k_EButton_Knuckles_JoyStick
    static void _set_k_EButton_Knuckles_JoyStick(::Valve::VR::EVRButtonId value);
