...
namespace Valve::VR {
  ...
  struct ETextureType/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Valve.VR.ETextureType Invalid
    static constexpr const int Invalid = -1;
    // Get static field: static public Valve.VR.ETextureType Invalid
    static ::Valve::VR::ETextureType _get_Invalid();
    // Set static field: static public Valve.VR.ETextureType Invalid
    static void _set_Invalid(::Valve::VR::ETextureType value);
    ...
    // static field const value: static public Valve.VR.ETextureType DXGISharedHandle
    static constexpr const int DXGISharedHandle = 5;
    // Get static field: static public Valve.VR.ETextureType DXGISharedHandle
    static ::Valve::VR::ETextureType _get_DXGISharedHandle();
    // Set static field: static public Valve.VR.ETextureType DXGISharedHandle
    static void _set_DXGISharedHandle(::Valve::VR::ETextureType value);
    // static field const value: static public Valve.VR.ETextureType Metal
    static constexpr const int Metal = 6;
    // Get static field: static public Valve.VR.ETextureType Metal
    static ::Valve::VR::ETextureType _get_Metal();
    // Set static field: static public Valve.VR.ETextureType Metal
    static void _set_Metal(::Valve::VR::ETextureType value);
