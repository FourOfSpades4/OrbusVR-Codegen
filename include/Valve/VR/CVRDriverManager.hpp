...
namespace Valve::VR {
  ...
  class CVRDriverManager : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::Valve::VR::IVRDriverManager) == 0x18);
    public:
    ...
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRDriverManager& dyn_FnTable();
...
// Writing MetadataGetter for method: Valve::VR::CVRDriverManager::GetDriverHandle
// Il2CppName: GetDriverHandle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint64_t (Valve::VR::CVRDriverManager::*)(::StringW)>(&Valve::VR::CVRDriverManager::GetDriverHandle)> {
  static const MethodInfo* get() {
    static auto* pchDriverName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::CVRDriverManager*), "GetDriverHandle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pchDriverName});
  }
};
