...
namespace Valve::VR {
  ...
  struct ETrackedDeviceClass/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Valve.VR.ETrackedDeviceClass Max
    static constexpr const int Max = 6;
    // Get static field: static public Valve.VR.ETrackedDeviceClass Max
    static ::Valve::VR::ETrackedDeviceClass _get_Max();
    // Set static field: static public Valve.VR.ETrackedDeviceClass Max
    static void _set_Max(::Valve::VR::ETrackedDeviceClass value);
