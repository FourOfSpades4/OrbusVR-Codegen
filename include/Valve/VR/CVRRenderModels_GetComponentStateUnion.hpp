...
namespace Valve::VR {
  ...
  struct CVRRenderModels::GetComponentStateUnion/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: public Valve.VR.IVRRenderModels/_GetComponentState pGetComponentState
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRRenderModels::_GetComponentState*& dyn_pGetComponentState();
    // Get instance field reference: public Valve.VR.CVRRenderModels/_GetComponentStatePacked pGetComponentStatePacked
