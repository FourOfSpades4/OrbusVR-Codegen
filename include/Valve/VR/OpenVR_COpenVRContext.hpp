...
namespace Valve::VR {
  ...
  class OpenVR::COpenVRContext : public ::Il2CppObject {
    ...
    // private Valve.VR.CVRInput m_pVRInput
    // Size: 0x8
    // Offset: 0x68
    ::Valve::VR::CVRInput* m_pVRInput;
    // Field size check
    static_assert(sizeof(::Valve::VR::CVRInput*) == 0x8);
    // private Valve.VR.CVRSpatialAnchors m_pVRSpatialAnchors
    // Size: 0x8
    // Offset: 0x70
    ::Valve::VR::CVRSpatialAnchors* m_pVRSpatialAnchors;
    // Field size check
    static_assert(sizeof(::Valve::VR::CVRSpatialAnchors*) == 0x8);
    public:
    ...
    // Get instance field reference: private Valve.VR.CVRInput m_pVRInput
    [[deprecated("Use field access instead!")]] ::Valve::VR::CVRInput*& dyn_m_pVRInput();
    // Get instance field reference: private Valve.VR.CVRSpatialAnchors m_pVRSpatialAnchors
    [[deprecated("Use field access instead!")]] ::Valve::VR::CVRSpatialAnchors*& dyn_m_pVRSpatialAnchors();
    ...
    // public Valve.VR.CVRInput VRInput()
    // Offset: 0xDCEFEC
    ::Valve::VR::CVRInput* VRInput();
    // public Valve.VR.CVRSpatialAnchors VRSpatialAnchors()
    // Offset: 0xDCF11C
    ::Valve::VR::CVRSpatialAnchors* VRSpatialAnchors();
  }; // Valve.VR.OpenVR/COpenVRContext
  #pragma pack(pop)
  static check_size<sizeof(OpenVR::COpenVRContext), 112 + sizeof(::Valve::VR::CVRSpatialAnchors*)> __Valve_VR_OpenVR_COpenVRContextSizeCheck;
...
// Writing MetadataGetter for method: Valve::VR::OpenVR::COpenVRContext::VRInput
// Il2CppName: VRInput
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Valve::VR::CVRInput* (Valve::VR::OpenVR::COpenVRContext::*)()>(&Valve::VR::OpenVR::COpenVRContext::VRInput)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::OpenVR::COpenVRContext*), "VRInput", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: Valve::VR::OpenVR::COpenVRContext::VRSpatialAnchors
// Il2CppName: VRSpatialAnchors
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Valve::VR::CVRSpatialAnchors* (Valve::VR::OpenVR::COpenVRContext::*)()>(&Valve::VR::OpenVR::COpenVRContext::VRSpatialAnchors)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::OpenVR::COpenVRContext*), "VRSpatialAnchors", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
