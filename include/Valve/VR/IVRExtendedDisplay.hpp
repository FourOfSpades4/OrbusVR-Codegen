...
namespace Valve::VR {
  ...
  struct IVRExtendedDisplay/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: Valve.VR.IVRExtendedDisplay/_GetWindowBounds GetWindowBounds
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRExtendedDisplay::_GetWindowBounds*& dyn_GetWindowBounds();
    // Get instance field reference: Valve.VR.IVRExtendedDisplay/_GetEyeOutputViewport GetEyeOutputViewport
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRExtendedDisplay::_GetEyeOutputViewport*& dyn_GetEyeOutputViewport();
    // Get instance field reference: Valve.VR.IVRExtendedDisplay/_GetDXGIOutputInfo GetDXGIOutputInfo
