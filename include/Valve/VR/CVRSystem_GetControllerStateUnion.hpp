...
namespace Valve::VR {
  ...
  struct CVRSystem::GetControllerStateUnion/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: public Valve.VR.IVRSystem/_GetControllerState pGetControllerState
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRSystem::_GetControllerState*& dyn_pGetControllerState();
    // Get instance field reference: public Valve.VR.CVRSystem/_GetControllerStatePacked pGetControllerStatePacked
    [[deprecated("Use field access instead!")]] ::Valve::VR::CVRSystem::_GetControllerStatePacked*& dyn_pGetControllerStatePacked();
