...
DEFINE_IL2CPP_ARG_TYPE(::Valve::VR::InputDigitalActionData_t, "Valve.VR", "InputDigitalActionData_t");
// Type namespace: Valve.VR
namespace Valve::VR {
  // Size: 0x18
  #pragma pack(push, 1)
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: Valve.VR.InputDigitalActionData_t
  ...
  #pragma pack(pop)
  static check_size<sizeof(InputDigitalActionData_t), 20 + sizeof(float)> __Valve_VR_InputDigitalActionData_tSizeCheck;
