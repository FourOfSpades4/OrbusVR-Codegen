...
namespace Valve::VR {
  ...
  class OpenVRInterop : public ::Il2CppObject {
    ...
    // static System.UInt32 InitInternal2(ref Valve.VR.EVRInitError peError, Valve.VR.EVRApplicationType eApplicationType, in System.String pStartupInfo)
    // Offset: 0xDCDA78
    static uint InitInternal2(ByRef<::Valve::VR::EVRInitError> peError, ::Valve::VR::EVRApplicationType eApplicationType, ByRef<::StringW> pStartupInfo);
    ...
    // static System.String RuntimePath()
    // Offset: 0xDCDD1C
...
// Writing MetadataGetter for method: Valve::VR::OpenVRInterop::InitInternal2
// Il2CppName: InitInternal2
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint (*)(ByRef<::Valve::VR::EVRInitError>, ::Valve::VR::EVRApplicationType, ByRef<::StringW>)>(&Valve::VR::OpenVRInterop::InitInternal2)> {
  static const MethodInfo* get() {
    static auto* peError = &::il2cpp_utils::GetClassFromName("Valve.VR", "EVRInitError")->this_arg;
    static auto* eApplicationType = &::il2cpp_utils::GetClassFromName("Valve.VR", "EVRApplicationType")->byval_arg;
    static auto* pStartupInfo = &::il2cpp_utils::GetClassFromName("System", "String")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::OpenVRInterop*), "InitInternal2", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{peError, eApplicationType, pStartupInfo});
  }
};
...
// Writing MetadataGetter for method: Valve::VR::OpenVRInterop::RuntimePath
// Il2CppName: RuntimePath
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)()>(&Valve::VR::OpenVRInterop::RuntimePath)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::OpenVRInterop*), "RuntimePath", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
