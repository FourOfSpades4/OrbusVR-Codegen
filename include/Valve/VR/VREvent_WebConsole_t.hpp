...
DEFINE_IL2CPP_ARG_TYPE(::Valve::VR::VREvent_WebConsole_t, "Valve.VR", "VREvent_WebConsole_t");
// Type namespace: Valve.VR
namespace Valve::VR {
  // Size: 0x8
  #pragma pack(push, 1)
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: Valve.VR.VREvent_WebConsole_t
  ...
  #pragma pack(pop)
  static check_size<sizeof(VREvent_WebConsole_t), 0 + sizeof(uint64_t)> __Valve_VR_VREvent_WebConsole_tSizeCheck;
