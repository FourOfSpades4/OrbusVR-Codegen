...
DEFINE_IL2CPP_ARG_TYPE(::Valve::VR::InputAnalogActionData_t, "Valve.VR", "InputAnalogActionData_t");
// Type namespace: Valve.VR
namespace Valve::VR {
  // Size: 0x2C
  #pragma pack(push, 1)
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: Valve.VR.InputAnalogActionData_t
  ...
  #pragma pack(pop)
  static check_size<sizeof(InputAnalogActionData_t), 40 + sizeof(float)> __Valve_VR_InputAnalogActionData_tSizeCheck;
