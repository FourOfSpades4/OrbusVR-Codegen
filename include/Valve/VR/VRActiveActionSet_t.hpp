...
DEFINE_IL2CPP_ARG_TYPE(::Valve::VR::VRActiveActionSet_t, "Valve.VR", "VRActiveActionSet_t");
// Type namespace: Valve.VR
namespace Valve::VR {
  // Size: 0x20
  #pragma pack(push, 1)
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: Valve.VR.VRActiveActionSet_t
  ...
  #pragma pack(pop)
  static check_size<sizeof(VRActiveActionSet_t), 28 + sizeof(int)> __Valve_VR_VRActiveActionSet_tSizeCheck;
