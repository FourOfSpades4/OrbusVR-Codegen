...
DEFINE_IL2CPP_ARG_TYPE(::Valve::VR::CVRSettingHelper, "Valve.VR", "CVRSettingHelper");
// Type namespace: Valve.VR
namespace Valve::VR {
  // Size: 0x8
  #pragma pack(push, 1)
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: Valve.VR.CVRSettingHelper
  ...
  #pragma pack(pop)
  static check_size<sizeof(CVRSettingHelper), 0 + sizeof(::System::IntPtr)> __Valve_VR_CVRSettingHelperSizeCheck;
