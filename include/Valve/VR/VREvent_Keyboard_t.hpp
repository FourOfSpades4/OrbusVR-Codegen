...
// Writing MetadataGetter for method: Valve::VR::VREvent_Keyboard_t::get_cNewInput
// Il2CppName: get_cNewInput
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (Valve::VR::VREvent_Keyboard_t::*)()>(&Valve::VR::VREvent_Keyboard_t::get_cNewInput)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::VREvent_Keyboard_t), "get_cNewInput", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
