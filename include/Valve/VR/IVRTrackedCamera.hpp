...
namespace Valve::VR {
  ...
  struct IVRTrackedCamera/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_GetCameraErrorNameFromEnum GetCameraErrorNameFromEnum
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRTrackedCamera::_GetCameraErrorNameFromEnum*& dyn_GetCameraErrorNameFromEnum();
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_HasCamera HasCamera
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRTrackedCamera::_HasCamera*& dyn_HasCamera();
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_GetCameraFrameSize GetCameraFrameSize
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRTrackedCamera::_GetCameraFrameSize*& dyn_GetCameraFrameSize();
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_GetCameraIntrinsics GetCameraIntrinsics
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRTrackedCamera::_GetCameraIntrinsics*& dyn_GetCameraIntrinsics();
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_GetCameraProjection GetCameraProjection
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRTrackedCamera::_GetCameraProjection*& dyn_GetCameraProjection();
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_AcquireVideoStreamingService AcquireVideoStreamingService
    ...
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_ReleaseVideoStreamingService ReleaseVideoStreamingService
    ...
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_GetVideoStreamFrameBuffer GetVideoStreamFrameBuffer
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRTrackedCamera::_GetVideoStreamFrameBuffer*& dyn_GetVideoStreamFrameBuffer();
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_GetVideoStreamTextureSize GetVideoStreamTextureSize
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRTrackedCamera::_GetVideoStreamTextureSize*& dyn_GetVideoStreamTextureSize();
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_GetVideoStreamTextureD3D11 GetVideoStreamTextureD3D11
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRTrackedCamera::_GetVideoStreamTextureD3D11*& dyn_GetVideoStreamTextureD3D11();
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_GetVideoStreamTextureGL GetVideoStreamTextureGL
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRTrackedCamera::_GetVideoStreamTextureGL*& dyn_GetVideoStreamTextureGL();
    // Get instance field reference: Valve.VR.IVRTrackedCamera/_ReleaseVideoStreamTextureGL ReleaseVideoStreamTextureGL
