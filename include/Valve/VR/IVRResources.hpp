...
namespace Valve::VR {
  ...
  struct IVRResources/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: Valve.VR.IVRResources/_LoadSharedResource LoadSharedResource
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRResources::_LoadSharedResource*& dyn_LoadSharedResource();
    // Get instance field reference: Valve.VR.IVRResources/_GetResourceFullPath GetResourceFullPath
