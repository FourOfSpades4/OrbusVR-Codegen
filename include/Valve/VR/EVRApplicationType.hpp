...
namespace Valve::VR {
  ...
  struct EVRApplicationType/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Valve.VR.EVRApplicationType VRApplication_WebHelper
    static constexpr const int VRApplication_WebHelper = 8;
    // Get static field: static public Valve.VR.EVRApplicationType VRApplication_WebHelper
    static ::Valve::VR::EVRApplicationType _get_VRApplication_WebHelper();
    // Set static field: static public Valve.VR.EVRApplicationType VRApplication_WebHelper
    static void _set_VRApplication_WebHelper(::Valve::VR::EVRApplicationType value);
    // static field const value: static public Valve.VR.EVRApplicationType VRApplication_Max
    static constexpr const int VRApplication_Max = 9;
