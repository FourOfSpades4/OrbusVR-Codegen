...
namespace Valve::VR {
  ...
  struct VROverlayFlags/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Valve.VR.VROverlayFlags MakeOverlaysInteractiveIfVisible
    static constexpr const int MakeOverlaysInteractiveIfVisible = 16;
    // Get static field: static public Valve.VR.VROverlayFlags MakeOverlaysInteractiveIfVisible
    static ::Valve::VR::VROverlayFlags _get_MakeOverlaysInteractiveIfVisible();
    // Set static field: static public Valve.VR.VROverlayFlags MakeOverlaysInteractiveIfVisible
    static void _set_MakeOverlaysInteractiveIfVisible(::Valve::VR::VROverlayFlags value);
