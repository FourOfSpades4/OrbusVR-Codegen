...
namespace Valve::VR {
  ...
  struct IVRScreenshots/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: Valve.VR.IVRScreenshots/_RequestScreenshot RequestScreenshot
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRScreenshots::_RequestScreenshot*& dyn_RequestScreenshot();
    // Get instance field reference: Valve.VR.IVRScreenshots/_HookScreenshot HookScreenshot
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRScreenshots::_HookScreenshot*& dyn_HookScreenshot();
    // Get instance field reference: Valve.VR.IVRScreenshots/_GetScreenshotPropertyType GetScreenshotPropertyType
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRScreenshots::_GetScreenshotPropertyType*& dyn_GetScreenshotPropertyType();
    // Get instance field reference: Valve.VR.IVRScreenshots/_GetScreenshotPropertyFilename GetScreenshotPropertyFilename
    ...
    // Get instance field reference: Valve.VR.IVRScreenshots/_UpdateScreenshotProgress UpdateScreenshotProgress
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRScreenshots::_UpdateScreenshotProgress*& dyn_UpdateScreenshotProgress();
    // Get instance field reference: Valve.VR.IVRScreenshots/_TakeStereoScreenshot TakeStereoScreenshot
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRScreenshots::_TakeStereoScreenshot*& dyn_TakeStereoScreenshot();
    // Get instance field reference: Valve.VR.IVRScreenshots/_SubmitScreenshot SubmitScreenshot
