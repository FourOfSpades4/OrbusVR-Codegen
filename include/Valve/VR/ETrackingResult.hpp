...
namespace Valve::VR {
  ...
  struct ETrackingResult/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Valve.VR.ETrackingResult Fallback_RotationOnly
    static constexpr const int Fallback_RotationOnly = 300;
    // Get static field: static public Valve.VR.ETrackingResult Fallback_RotationOnly
    static ::Valve::VR::ETrackingResult _get_Fallback_RotationOnly();
    // Set static field: static public Valve.VR.ETrackingResult Fallback_RotationOnly
    static void _set_Fallback_RotationOnly(::Valve::VR::ETrackingResult value);
