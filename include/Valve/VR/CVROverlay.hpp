...
namespace Valve::VR {
  ...
  class CVROverlay : public ::Il2CppObject {
    ...
    // public Valve.VR.EVROverlayError SetOverlayDualAnalogTransform(System.UInt64 ulOverlay, Valve.VR.EDualAnalogWhich eWhich, ref Valve.VR.HmdVector2_t pvCenter, System.Single fRadius)
    // Offset: 0xFF89F0
    ::Valve::VR::EVROverlayError SetOverlayDualAnalogTransform(uint64_t ulOverlay, ::Valve::VR::EDualAnalogWhich eWhich, ByRef<::Valve::VR::HmdVector2_t> pvCenter, float fRadius);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Valve::VR::EVROverlayError (Valve::VR::CVROverlay::*)(uint64_t, ::Valve::VR::EDualAnalogWhich, ByRef<::Valve::VR::HmdVector2_t>, float)>(&Valve::VR::CVROverlay::SetOverlayDualAnalogTransform)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::CVROverlay*), "SetOverlayDualAnalogTransform", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ulOverlay, eWhich, pvCenter, fRadius});
  }
};
