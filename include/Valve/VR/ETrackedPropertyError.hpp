...
namespace Valve::VR {
  ...
  struct ETrackedPropertyError/*, public ::System::Enum*/ {
    ...
    // static field const value: static public Valve.VR.ETrackedPropertyError TrackedProp_IPCReadFailure
    static constexpr const int TrackedProp_IPCReadFailure = 13;
    // Get static field: static public Valve.VR.ETrackedPropertyError TrackedProp_IPCReadFailure
    static ::Valve::VR::ETrackedPropertyError _get_TrackedProp_IPCReadFailure();
    // Set static field: static public Valve.VR.ETrackedPropertyError TrackedProp_IPCReadFailure
    static void _set_TrackedProp_IPCReadFailure(::Valve::VR::ETrackedPropertyError value);
