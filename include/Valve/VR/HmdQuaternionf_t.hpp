...
DEFINE_IL2CPP_ARG_TYPE(::Valve::VR::HmdQuaternionf_t, "Valve.VR", "HmdQuaternionf_t");
// Type namespace: Valve.VR
namespace Valve::VR {
  // Size: 0x10
  #pragma pack(push, 1)
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: Valve.VR.HmdQuaternionf_t
  ...
  #pragma pack(pop)
  static check_size<sizeof(HmdQuaternionf_t), 12 + sizeof(float)> __Valve_VR_HmdQuaternionf_tSizeCheck;
