...
namespace Valve::VR {
  ...
  // [UnmanagedFunctionPointerAttribute] Offset: ACF098
  class IVRTrackedCamera::_GetCameraProjection : public ::System::MulticastDelegate {
    ...
    // public Valve.VR.EVRTrackedCameraError Invoke(System.UInt32 nDeviceIndex, System.UInt32 nCameraIndex, Valve.VR.EVRTrackedCameraFrameType eFrameType, System.Single flZNear, System.Single flZFar, ref Valve.VR.HmdMatrix44_t pProjection)
    // Offset: 0x115169C
    ::Valve::VR::EVRTrackedCameraError Invoke(uint nDeviceIndex, uint nCameraIndex, ::Valve::VR::EVRTrackedCameraFrameType eFrameType, float flZNear, float flZFar, ByRef<::Valve::VR::HmdMatrix44_t> pProjection);
    // public System.IAsyncResult BeginInvoke(System.UInt32 nDeviceIndex, System.UInt32 nCameraIndex, Valve.VR.EVRTrackedCameraFrameType eFrameType, System.Single flZNear, System.Single flZFar, ref Valve.VR.HmdMatrix44_t pProjection, System.AsyncCallback callback, System.Object object)
    // Offset: 0x1151BD4
    ::System::IAsyncResult* BeginInvoke(uint nDeviceIndex, uint nCameraIndex, ::Valve::VR::EVRTrackedCameraFrameType eFrameType, float flZNear, float flZFar, ByRef<::Valve::VR::HmdMatrix44_t> pProjection, ::System::AsyncCallback* callback, ::Il2CppObject* object);
...
// Il2CppName: Invoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Valve::VR::EVRTrackedCameraError (Valve::VR::IVRTrackedCamera::_GetCameraProjection::*)(uint, uint, ::Valve::VR::EVRTrackedCameraFrameType, float, float, ByRef<::Valve::VR::HmdMatrix44_t>)>(&Valve::VR::IVRTrackedCamera::_GetCameraProjection::Invoke)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRTrackedCamera::_GetCameraProjection*), "Invoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{nDeviceIndex, nCameraIndex, eFrameType, flZNear, flZFar, pProjection});
  }
};
// Writing MetadataGetter for method: Valve::VR::IVRTrackedCamera::_GetCameraProjection::BeginInvoke
// Il2CppName: BeginInvoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IAsyncResult* (Valve::VR::IVRTrackedCamera::_GetCameraProjection::*)(uint, uint, ::Valve::VR::EVRTrackedCameraFrameType, float, float, ByRef<::Valve::VR::HmdMatrix44_t>, ::System::AsyncCallback*, ::Il2CppObject*)>(&Valve::VR::IVRTrackedCamera::_GetCameraProjection::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* nDeviceIndex = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    static auto* nCameraIndex = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    static auto* eFrameType = &::il2cpp_utils::GetClassFromName("Valve.VR", "EVRTrackedCameraFrameType")->byval_arg;
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::IVRTrackedCamera::_GetCameraProjection*), "BeginInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{nDeviceIndex, nCameraIndex, eFrameType, flZNear, flZFar, pProjection, callback, object});
  }
};
