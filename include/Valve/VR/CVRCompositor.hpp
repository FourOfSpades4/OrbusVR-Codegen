...
namespace Valve::VR {
  ...
  class CVRCompositor : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::Valve::VR::IVRCompositor) == 0x160);
    public:
    ...
    // public System.Boolean IsMotionSmoothingEnabled()
    // Offset: 0xFF6040
  ...
  static_assert(sizeof(CVRCompositor) == 0x170);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: Valve::VR::CVRCompositor::IsMotionSmoothingEnabled
// Il2CppName: IsMotionSmoothingEnabled
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Valve::VR::CVRCompositor::*)()>(&Valve::VR::CVRCompositor::IsMotionSmoothingEnabled)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::CVRCompositor*), "IsMotionSmoothingEnabled", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
