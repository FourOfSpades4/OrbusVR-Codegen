...
namespace Valve::VR {
  ...
  class CVRRenderModels : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::Valve::VR::IVRRenderModels) == 0x98);
    public:
    ...
    // public System.Boolean GetComponentStateForDevicePath(System.String pchRenderModelName, System.String pchComponentName, System.UInt64 devicePath, ref Valve.VR.RenderModel_ControllerMode_State_t pState, ref Valve.VR.RenderModel_ComponentState_t pComponentState)
    // Offset: 0xFF9810
    bool GetComponentStateForDevicePath(::StringW pchRenderModelName, ::StringW pchComponentName, uint64_t devicePath, ByRef<::Valve::VR::RenderModel_ControllerMode_State_t> pState, ByRef<::Valve::VR::RenderModel_ComponentState_t> pComponentState);
...
// Writing MetadataGetter for method: Valve::VR::CVRRenderModels::GetComponentStateForDevicePath
// Il2CppName: GetComponentStateForDevicePath
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Valve::VR::CVRRenderModels::*)(::StringW, ::StringW, uint64_t, ByRef<::Valve::VR::RenderModel_ControllerMode_State_t>, ByRef<::Valve::VR::RenderModel_ComponentState_t>)>(&Valve::VR::CVRRenderModels::GetComponentStateForDevicePath)> {
  static const MethodInfo* get() {
    static auto* pchRenderModelName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* pchComponentName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::CVRRenderModels*), "GetComponentStateForDevicePath", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{pchRenderModelName, pchComponentName, devicePath, pState, pComponentState});
  }
};
