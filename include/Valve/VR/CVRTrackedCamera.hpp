...
namespace Valve::VR {
  ...
  class CVRTrackedCamera : public ::Il2CppObject {
    ...
    // public Valve.VR.EVRTrackedCameraError GetCameraIntrinsics(System.UInt32 nDeviceIndex, System.UInt32 nCameraIndex, Valve.VR.EVRTrackedCameraFrameType eFrameType, ref Valve.VR.HmdVector2_t pFocalLength, ref Valve.VR.HmdVector2_t pCenter)
    // Offset: 0xFFD970
    ::Valve::VR::EVRTrackedCameraError GetCameraIntrinsics(uint nDeviceIndex, uint nCameraIndex, ::Valve::VR::EVRTrackedCameraFrameType eFrameType, ByRef<::Valve::VR::HmdVector2_t> pFocalLength, ByRef<::Valve::VR::HmdVector2_t> pCenter);
    // public Valve.VR.EVRTrackedCameraError GetCameraProjection(System.UInt32 nDeviceIndex, System.UInt32 nCameraIndex, Valve.VR.EVRTrackedCameraFrameType eFrameType, System.Single flZNear, System.Single flZFar, ref Valve.VR.HmdMatrix44_t pProjection)
    // Offset: 0xFFD9D8
    ::Valve::VR::EVRTrackedCameraError GetCameraProjection(uint nDeviceIndex, uint nCameraIndex, ::Valve::VR::EVRTrackedCameraFrameType eFrameType, float flZNear, float flZFar, ByRef<::Valve::VR::HmdMatrix44_t> pProjection);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Valve::VR::EVRTrackedCameraError (Valve::VR::CVRTrackedCamera::*)(uint, uint, ::Valve::VR::EVRTrackedCameraFrameType, ByRef<::Valve::VR::HmdVector2_t>, ByRef<::Valve::VR::HmdVector2_t>)>(&Valve::VR::CVRTrackedCamera::GetCameraIntrinsics)> {
  static const MethodInfo* get() {
    static auto* nDeviceIndex = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::CVRTrackedCamera*), "GetCameraIntrinsics", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{nDeviceIndex, nCameraIndex, eFrameType, pFocalLength, pCenter});
  }
};
// Writing MetadataGetter for method: Valve::VR::CVRTrackedCamera::GetCameraProjection
// Il2CppName: GetCameraProjection
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Valve::VR::EVRTrackedCameraError (Valve::VR::CVRTrackedCamera::*)(uint, uint, ::Valve::VR::EVRTrackedCameraFrameType, float, float, ByRef<::Valve::VR::HmdMatrix44_t>)>(&Valve::VR::CVRTrackedCamera::GetCameraProjection)> {
  static const MethodInfo* get() {
    static auto* nDeviceIndex = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    static auto* nCameraIndex = &::il2cpp_utils::GetClassFromName("System", "UInt32")->byval_arg;
    static auto* eFrameType = &::il2cpp_utils::GetClassFromName("Valve.VR", "EVRTrackedCameraFrameType")->byval_arg;
    ...
    return ::il2cpp_utils::FindMethod(classof(Valve::VR::CVRTrackedCamera*), "GetCameraProjection", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{nDeviceIndex, nCameraIndex, eFrameType, flZNear, flZFar, pProjection});
  }
};
