...
// Including type: Valve.VR.VREvent_WebConsole_t
#include "Valve/VR/VREvent_WebConsole_t.hpp"
// Including type: Valve.VR.VREvent_InputBindingLoad_t
#include "Valve/VR/VREvent_InputBindingLoad_t.hpp"
// Including type: Valve.VR.VREvent_SpatialAnchor_t
#include "Valve/VR/VREvent_SpatialAnchor_t.hpp"
// Including type: Valve.VR.VREvent_InputActionManifestLoad_t
#include "Valve/VR/VREvent_InputActionManifestLoad_t.hpp"
// Including type: Valve.VR.VREvent_ProgressUpdate_t
#include "Valve/VR/VREvent_ProgressUpdate_t.hpp"
// Including type: Valve.VR.VREvent_ShowUI_t
#include "Valve/VR/VREvent_ShowUI_t.hpp"
...
namespace Valve::VR {
  ...
  struct VREvent_Data_t/*, public ::System::ValueType*/ {
    ...
    // Field size check
    static_assert(sizeof(::Valve::VR::VREvent_Reserved_t) == 0x30);
    ...
    // Field size check
    static_assert(sizeof(::Valve::VR::VREvent_Overlay_t) == 0x10);
    ...
    // public Valve.VR.VREvent_WebConsole_t webConsole
    // Size: 0x8
    // Offset: 0x0
    ::Valve::VR::VREvent_WebConsole_t webConsole;
    // Field size check
    static_assert(sizeof(::Valve::VR::VREvent_WebConsole_t) == 0x8);
    // public Valve.VR.VREvent_InputBindingLoad_t inputBinding
    // Size: 0x20
    // Offset: 0x0
    ::Valve::VR::VREvent_InputBindingLoad_t inputBinding;
    // Field size check
    static_assert(sizeof(::Valve::VR::VREvent_InputBindingLoad_t) == 0x20);
    // public Valve.VR.VREvent_SpatialAnchor_t spatialAnchor
    // Size: 0x4
    // Offset: 0x0
    ::Valve::VR::VREvent_SpatialAnchor_t spatialAnchor;
    // Field size check
    static_assert(sizeof(::Valve::VR::VREvent_SpatialAnchor_t) == 0x4);
    // public Valve.VR.VREvent_InputActionManifestLoad_t actionManifest
    // Size: 0x20
    // Offset: 0x0
    ::Valve::VR::VREvent_InputActionManifestLoad_t actionManifest;
    // Field size check
    static_assert(sizeof(::Valve::VR::VREvent_InputActionManifestLoad_t) == 0x20);
    // public Valve.VR.VREvent_ProgressUpdate_t progressUpdate
    // Size: 0x2C
    // Offset: 0x0
    ::Valve::VR::VREvent_ProgressUpdate_t progressUpdate;
    // Field size check
    static_assert(sizeof(::Valve::VR::VREvent_ProgressUpdate_t) == 0x2C);
    // public Valve.VR.VREvent_ShowUI_t showUi
    // Size: 0x4
    // Offset: 0x0
    ::Valve::VR::VREvent_ShowUI_t showUi;
    // Field size check
    static_assert(sizeof(::Valve::VR::VREvent_ShowUI_t) == 0x4);
    ...
    constexpr VREvent_Data_t(::Valve::VR::VREvent_Reserved_t reserved_ = {}, ::Valve::VR::VREvent_Controller_t controller_ = {}, ::Valve::VR::VREvent_Mouse_t mouse_ = {}, ::Valve::VR::VREvent_Scroll_t scroll_ = {}, ::Valve::VR::VREvent_Process_t process_ = {}, ::Valve::VR::VREvent_Notification_t notification_ = {}, ::Valve::VR::VREvent_Overlay_t overlay_ = {}, ::Valve::VR::VREvent_Status_t status_ = {}, ::Valve::VR::VREvent_Ipd_t ipd_ = {}, ::Valve::VR::VREvent_Chaperone_t chaperone_ = {}, ::Valve::VR::VREvent_PerformanceTest_t performanceTest_ = {}, ::Valve::VR::VREvent_TouchPadMove_t touchPadMove_ = {}, ::Valve::VR::VREvent_SeatedZeroPoseReset_t seatedZeroPoseReset_ = {}, ::Valve::VR::VREvent_Screenshot_t screenshot_ = {}, ::Valve::VR::VREvent_ScreenshotProgress_t screenshotProgress_ = {}, ::Valve::VR::VREvent_ApplicationLaunch_t applicationLaunch_ = {}, ::Valve::VR::VREvent_EditingCameraSurface_t cameraSurface_ = {}, ::Valve::VR::VREvent_MessageOverlay_t messageOverlay_ = {}, ::Valve::VR::VREvent_Property_t property_ = {}, ::Valve::VR::VREvent_DualAnalog_t dualAnalog_ = {}, ::Valve::VR::VREvent_HapticVibration_t hapticVibration_ = {}, ::Valve::VR::VREvent_WebConsole_t webConsole_ = {}, ::Valve::VR::VREvent_InputBindingLoad_t inputBinding_ = {}, ::Valve::VR::VREvent_SpatialAnchor_t spatialAnchor_ = {}, ::Valve::VR::VREvent_InputActionManifestLoad_t actionManifest_ = {}, ::Valve::VR::VREvent_ProgressUpdate_t progressUpdate_ = {}, ::Valve::VR::VREvent_ShowUI_t showUi_ = {}, ::Valve::VR::VREvent_Keyboard_t keyboard_ = {}) noexcept : reserved{reserved_}, controller{controller_}, mouse{mouse_}, scroll{scroll_}, process{process_}, notification{notification_}, overlay{overlay_}, status{status_}, ipd{ipd_}, chaperone{chaperone_}, performanceTest{performanceTest_}, touchPadMove{touchPadMove_}, seatedZeroPoseReset{seatedZeroPoseReset_}, screenshot{screenshot_}, screenshotProgress{screenshotProgress_}, applicationLaunch{applicationLaunch_}, cameraSurface{cameraSurface_}, messageOverlay{messageOverlay_}, property{property_}, dualAnalog{dualAnalog_}, hapticVibration{hapticVibration_}, webConsole{webConsole_}, inputBinding{inputBinding_}, spatialAnchor{spatialAnchor_}, actionManifest{actionManifest_}, progressUpdate{progressUpdate_}, showUi{showUi_}, keyboard{keyboard_} {}
    ...
    // Get instance field reference: public Valve.VR.VREvent_WebConsole_t webConsole
    [[deprecated("Use field access instead!")]] ::Valve::VR::VREvent_WebConsole_t& dyn_webConsole();
    // Get instance field reference: public Valve.VR.VREvent_InputBindingLoad_t inputBinding
    [[deprecated("Use field access instead!")]] ::Valve::VR::VREvent_InputBindingLoad_t& dyn_inputBinding();
    // Get instance field reference: public Valve.VR.VREvent_SpatialAnchor_t spatialAnchor
    [[deprecated("Use field access instead!")]] ::Valve::VR::VREvent_SpatialAnchor_t& dyn_spatialAnchor();
    // Get instance field reference: public Valve.VR.VREvent_InputActionManifestLoad_t actionManifest
    [[deprecated("Use field access instead!")]] ::Valve::VR::VREvent_InputActionManifestLoad_t& dyn_actionManifest();
    // Get instance field reference: public Valve.VR.VREvent_ProgressUpdate_t progressUpdate
    [[deprecated("Use field access instead!")]] ::Valve::VR::VREvent_ProgressUpdate_t& dyn_progressUpdate();
    // Get instance field reference: public Valve.VR.VREvent_ShowUI_t showUi
    [[deprecated("Use field access instead!")]] ::Valve::VR::VREvent_ShowUI_t& dyn_showUi();
