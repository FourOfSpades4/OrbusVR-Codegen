...
namespace Valve::VR {
  ...
  struct IVRNotifications/*, public ::System::ValueType*/ {
    ...
    // Get instance field reference: Valve.VR.IVRNotifications/_CreateNotification CreateNotification
    [[deprecated("Use field access instead!")]] ::Valve::VR::IVRNotifications::_CreateNotification*& dyn_CreateNotification();
    // Get instance field reference: Valve.VR.IVRNotifications/_RemoveNotification RemoveNotification
