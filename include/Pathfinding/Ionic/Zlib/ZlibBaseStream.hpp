...
// Writing MetadataGetter for method: Pathfinding::Ionic::Zlib::ZlibBaseStream::get_Crc32
// Il2CppName: get_Crc32
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (Pathfinding::Ionic::Zlib::ZlibBaseStream::*)()>(&Pathfinding::Ionic::Zlib::ZlibBaseStream::get_Crc32)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::Ionic::Zlib::ZlibBaseStream*), "get_Crc32", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
