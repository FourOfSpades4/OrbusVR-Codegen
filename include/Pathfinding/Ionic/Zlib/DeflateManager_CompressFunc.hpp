...
namespace Pathfinding::Ionic::Zlib {
  ...
  class DeflateManager::CompressFunc : public ::System::MulticastDelegate {
    ...
    // public System.IAsyncResult BeginInvoke(Pathfinding.Ionic.Zlib.FlushType flush, System.AsyncCallback callback, System.Object object)
    // Offset: 0x25DF318
    ::System::IAsyncResult* BeginInvoke(::Pathfinding::Ionic::Zlib::FlushType flush, ::System::AsyncCallback* callback, ::Il2CppObject* object);
    // public Pathfinding.Ionic.Zlib.BlockState EndInvoke(System.IAsyncResult result)
    // Offset: 0x25DF3A4
    ::Pathfinding::Ionic::Zlib::BlockState EndInvoke(::System::IAsyncResult* result);
...
// Writing MetadataGetter for method: Pathfinding::Ionic::Zlib::DeflateManager::CompressFunc::BeginInvoke
// Il2CppName: BeginInvoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IAsyncResult* (Pathfinding::Ionic::Zlib::DeflateManager::CompressFunc::*)(::Pathfinding::Ionic::Zlib::FlushType, ::System::AsyncCallback*, ::Il2CppObject*)>(&Pathfinding::Ionic::Zlib::DeflateManager::CompressFunc::BeginInvoke)> {
  static const MethodInfo* get() {
    static auto* flush = &::il2cpp_utils::GetClassFromName("Pathfinding.Ionic.Zlib", "FlushType")->byval_arg;
    static auto* callback = &::il2cpp_utils::GetClassFromName("System", "AsyncCallback")->byval_arg;
    static auto* object = &::il2cpp_utils::GetClassFromName("System", "Object")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::Ionic::Zlib::DeflateManager::CompressFunc*), "BeginInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{flush, callback, object});
  }
};
// Writing MetadataGetter for method: Pathfinding::Ionic::Zlib::DeflateManager::CompressFunc::EndInvoke
// Il2CppName: EndInvoke
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Pathfinding::Ionic::Zlib::BlockState (Pathfinding::Ionic::Zlib::DeflateManager::CompressFunc::*)(::System::IAsyncResult*)>(&Pathfinding::Ionic::Zlib::DeflateManager::CompressFunc::EndInvoke)> {
  static const MethodInfo* get() {
    static auto* result = &::il2cpp_utils::GetClassFromName("System", "IAsyncResult")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Pathfinding::Ionic::Zlib::DeflateManager::CompressFunc*), "EndInvoke", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{result});
  }
};
