...
namespace Oculus::Platform::Samples::VrVoiceChat {
  // Size: 0x20
  #pragma pack(push, 1)
  // Autogenerated type: Oculus.Platform.Samples.VrVoiceChat.PlatformManager/<>c__DisplayClass31_0
  // [TokenAttribute] Offset: FFFFFFFF
  // [CompilerGeneratedAttribute] Offset: AB339C
  class PlatformManager::$$c__DisplayClass31_0 : public ::Il2CppObject {
    public:
    public:
    // public Oculus.Platform.Samples.VrVoiceChat.RoomManager/Invite invite
    // Size: 0x10
    // Offset: 0x10
    ...
    // Get instance field reference: public Oculus.Platform.Samples.VrVoiceChat.RoomManager/Invite invite
