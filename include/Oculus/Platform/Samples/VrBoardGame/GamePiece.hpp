...
namespace Oculus::Platform::Samples::VrBoardGame {
  ...
  class GamePiece : public ::UnityEngine::MonoBehaviour {
    ...
    // Size: 0x4
    #pragma pack(push, 1)
    // Autogenerated type: Oculus.Platform.Samples.VrBoardGame.GamePiece/Piece
    // [TokenAttribute] Offset: FFFFFFFF
    struct Piece/*, public ::System::Enum*/ {
      ...
      // static field const value: static public Oculus.Platform.Samples.VrBoardGame.GamePiece/Piece A
      ...
      // static field const value: static public Oculus.Platform.Samples.VrBoardGame.GamePiece/Piece B
      ...
      // static field const value: static public Oculus.Platform.Samples.VrBoardGame.GamePiece/Piece PowerBall
    ...
    public:
    // private Oculus.Platform.Samples.VrBoardGame.GamePiece/Piece m_type
    // Size: 0x4
    // Offset: 0x18
    ...
    // Get instance field reference: private Oculus.Platform.Samples.VrBoardGame.GamePiece/Piece m_type
    ...
    // public Oculus.Platform.Samples.VrBoardGame.GamePiece/Piece get_Type()
    // Offset: 0x1531D18
    ...
    // public UnityEngine.GameObject PrefabFor(Oculus.Platform.Samples.VrBoardGame.GamePiece/Piece p)
    // Offset: 0x1531C58
