...
namespace Oculus::Platform::Samples::VrBoardGame {
  ...
  class GameBoard : public ::UnityEngine::MonoBehaviour {
    ...
    // Autogenerated type: Oculus.Platform.Samples.VrBoardGame.GameBoard/PositionInfo
    // [TokenAttribute] Offset: FFFFFFFF
    ...
    // private readonly Oculus.Platform.Samples.VrBoardGame.GameBoard/PositionInfo[,] m_pieces
    // Size: 0x8
    // Offset: 0x40
    ...
    // Get instance field reference: private readonly Oculus.Platform.Samples.VrBoardGame.GameBoard/PositionInfo[,] m_pieces
