...
namespace Proyecto26 {
  ...
  class RequestException : public ::System::Exception {
    ...
    // public System.Void .ctor(System.String message, System.Boolean isHttpError, System.Boolean isNetworkError, System.Int64 statusCode)
    // Offset: 0xE23994
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static RequestException* New_ctor(::StringW message, bool isHttpError, bool isNetworkError, int64_t statusCode) {
      static auto ___internal__logger = ::Logger::get().WithContext("::Proyecto26::RequestException::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<RequestException*, creationType>(message, isHttpError, isNetworkError, statusCode)));
    }
  }; // Proyecto26.RequestException
  #pragma pack(pop)
  static check_size<sizeof(RequestException), 152 + sizeof(::StringW)> __Proyecto26_RequestExceptionSizeCheck;
  static_assert(sizeof(RequestException) == 0xA0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
