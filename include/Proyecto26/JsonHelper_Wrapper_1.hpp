...
namespace Proyecto26 {
  ...
  // Autogenerated type: Proyecto26.JsonHelper/Wrapper`1
  ...
  }; // Proyecto26.JsonHelper/Wrapper`1
  // Could not write size check! Type: Proyecto26.JsonHelper/Wrapper`1 is generic, or has no fields that are valid for size checks!
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
