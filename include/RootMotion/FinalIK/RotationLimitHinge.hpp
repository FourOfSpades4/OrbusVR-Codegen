...
namespace RootMotion::FinalIK {
  ...
  // [HelpURLAttribute] Offset: AC1C0C
  // [AddComponentMenu] Offset: AC1C0C
  ...
  #pragma pack(pop)
  static check_size<sizeof(RotationLimitHinge), 84 + sizeof(float)> __RootMotion_FinalIK_RotationLimitHingeSizeCheck;
  static_assert(sizeof(RotationLimitHinge) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
