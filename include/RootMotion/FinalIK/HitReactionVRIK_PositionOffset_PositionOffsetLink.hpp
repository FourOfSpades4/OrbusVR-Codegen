...
namespace RootMotion::FinalIK {
  ...
  class HitReactionVRIK::PositionOffset::PositionOffsetLink : public ::Il2CppObject {
    public:
    public:
    // [TooltipAttribute] Offset: 0xAC99FC
    ...
    // [TooltipAttribute] Offset: 0xAC9A34
    ...
    static_assert(sizeof(::UnityEngine::Vector3) == 0xC);
    public:
    // Get instance field reference: public RootMotion.FinalIK.IKSolverVR/PositionOffset positionOffset
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolverVR::PositionOffset& dyn_positionOffset();
