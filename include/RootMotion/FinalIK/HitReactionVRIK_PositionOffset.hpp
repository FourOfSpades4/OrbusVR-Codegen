...
namespace RootMotion::FinalIK {
  ...
  class HitReactionVRIK::PositionOffset : public ::RootMotion::FinalIK::HitReactionVRIK::Offset {
    ...
    public:
    // [TooltipAttribute] Offset: 0xAC8F24
    ...
    // [TooltipAttribute] Offset: 0xAC8F5C
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [TooltipAttribute] Offset: 0xAC8F94
    ...
    // Get instance field reference: public RootMotion.FinalIK.HitReactionVRIK/PositionOffset/PositionOffsetLink[] offsetLinks
