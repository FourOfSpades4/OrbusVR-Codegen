...
namespace RootMotion::FinalIK {
  ...
  // [AddComponentMenu] Offset: AC1990
  class VRIK : public ::RootMotion::FinalIK::IK {
    ...
    class References;
    public:
    // [ContextMenuItemAttribute] Offset: 0xAC3C64
    // [TooltipAttribute] Offset: 0xAC3C64
    ...
    // [TooltipAttribute] Offset: 0xAC3CE0
    ...
    public:
    // Get instance field reference: public RootMotion.FinalIK.VRIK/References references
