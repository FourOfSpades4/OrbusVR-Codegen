...
namespace RootMotion::FinalIK {
  ...
  // [HelpURLAttribute] Offset: AC19C8
  // [AddComponentMenu] Offset: AC19C8
  class InteractionObject : public ::UnityEngine::MonoBehaviour {
    ...
    class WeightCurve : public ::Il2CppObject {
      ...
      public:
      // [TooltipAttribute] Offset: 0xAC8520
      ...
      char __padding0[0x4] = {};
      // [TooltipAttribute] Offset: 0xAC8558
      ...
      public:
      // Get instance field reference: public RootMotion.FinalIK.InteractionObject/WeightCurve/Type type
    ...
    public:
    // [TooltipAttribute] Offset: 0xAC4B00
    ...
    // [TooltipAttribute] Offset: 0xAC4B38
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Transform*) == 0x8);
    // [TooltipAttribute] Offset: 0xAC4B70
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAC4BA8
    ...
    char __padding6[0x4] = {};
    // [CompilerGeneratedAttribute] Offset: 0xAC4BB8
    ...
    // Get instance field reference: public RootMotion.FinalIK.InteractionObject/WeightCurve[] weightCurves
    [[deprecated("Use field access instead!")]] ::ArrayW<::RootMotion::FinalIK::InteractionObject::WeightCurve*>& dyn_weightCurves();
    // Get instance field reference: public RootMotion.FinalIK.InteractionObject/Multiplier[] multipliers
    [[deprecated("Use field access instead!")]] ::ArrayW<::RootMotion::FinalIK::InteractionObject::Multiplier*>& dyn_multipliers();
    // Get instance field reference: public RootMotion.FinalIK.InteractionObject/InteractionEvent[] events
...
// Writing MetadataGetter for method: RootMotion::FinalIK::InteractionObject::Awake
// Il2CppName: Awake
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::InteractionObject::*)()>(&RootMotion::FinalIK::InteractionObject::Awake)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(RootMotion::FinalIK::InteractionObject*), "Awake", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: RootMotion::FinalIK::InteractionObject::Apply
// Il2CppName: Apply
