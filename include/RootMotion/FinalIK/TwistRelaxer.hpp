...
namespace RootMotion::FinalIK {
  ...
  class TwistRelaxer : public ::UnityEngine::MonoBehaviour {
    ...
    // [TooltipAttribute] Offset: 0xAC4914
    // [RangeAttribute] Offset: 0xAC4914
    ...
    // [TooltipAttribute] Offset: 0xAC4968
    // [RangeAttribute] Offset: 0xAC4968
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAC49BC
    // [RangeAttribute] Offset: 0xAC49BC
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Vector3) == 0xC);
    // Padding between fields: axisRelativeToChildDefault and: parent
    char __padding7[0x4] = {};
    ...
    // Get instance field reference: private UnityEngine.Transform child
  ...
  #pragma pack(pop)
  static check_size<sizeof(TwistRelaxer), 104 + sizeof(::UnityEngine::Transform*)> __RootMotion_FinalIK_TwistRelaxerSizeCheck;
  static_assert(sizeof(TwistRelaxer) == 0x70);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
