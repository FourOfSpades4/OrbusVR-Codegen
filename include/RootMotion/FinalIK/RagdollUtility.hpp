...
namespace RootMotion::FinalIK {
  ...
  // [RequireComponent] Offset: AC1B48
  class RagdollUtility : public ::UnityEngine::MonoBehaviour {
    ...
    public:
    // [TooltipAttribute] Offset: 0xAC50E4
    ...
    // [TooltipAttribute] Offset: 0xAC511C
    ...
    // [TooltipAttribute] Offset: 0xAC5154
    ...
    char __padding2[0x3] = {};
    // [TooltipAttribute] Offset: 0xAC518C
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAC51C4
    ...
    // Get instance field reference: private RootMotion.FinalIK.RagdollUtility/Rigidbone[] rigidbones
    [[deprecated("Use field access instead!")]] ::ArrayW<::RootMotion::FinalIK::RagdollUtility::Rigidbone*>& dyn_rigidbones();
    // Get instance field reference: private RootMotion.FinalIK.RagdollUtility/Child[] children
