...
namespace RootMotion::FinalIK {
  // Forward declaring type: Grounder
  class Grounder;
}
...
namespace RootMotion::FinalIK {
  ...
  class Grounder : public ::UnityEngine::MonoBehaviour {
    ...
    public:
    // [TooltipAttribute] Offset: 0xAC3110
    // [RangeAttribute] Offset: 0xAC3110
    ...
    char __padding0[0x4] = {};
    // [TooltipAttribute] Offset: 0xAC3164
    ...
    // Get instance field reference: public RootMotion.FinalIK.Grounder/GrounderDelegate OnPreGrounder
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::Grounder::GrounderDelegate*& dyn_OnPreGrounder();
    // Get instance field reference: public RootMotion.FinalIK.Grounder/GrounderDelegate OnPostGrounder
