...
namespace RootMotion::FinalIK {
  ...
  class IKSolverVR : public ::RootMotion::FinalIK::IKSolver {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Padding between fields: hasToes and: readPositions
    char __padding4[0x4] = {};
    ...
    // [TooltipAttribute] Offset: 0xAC477C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAC47B4
    ...
    // [TooltipAttribute] Offset: 0xAC47C4
    ...
    // [TooltipAttribute] Offset: 0xAC47FC
    ...
    // [TooltipAttribute] Offset: 0xAC4834
    ...
    // Field size check
    static_assert(sizeof(::RootMotion::FinalIK::IKSolverVR::Arm*) == 0x8);
    // [TooltipAttribute] Offset: 0xAC486C
    ...
    // [TooltipAttribute] Offset: 0xAC48A4
    ...
    // Field size check
    static_assert(sizeof(::RootMotion::FinalIK::IKSolverVR::Leg*) == 0x8);
    // [TooltipAttribute] Offset: 0xAC48DC
    ...
    // Get instance field reference: private RootMotion.FinalIK.IKSolverVR/VirtualBone <rootBone>k__BackingField
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolverVR::VirtualBone*& dyn_$rootBone$k__BackingField();
    // Get instance field reference: public RootMotion.FinalIK.IKSolverVR/Spine spine
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolverVR::Spine*& dyn_spine();
    // Get instance field reference: public RootMotion.FinalIK.IKSolverVR/Arm leftArm
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolverVR::Arm*& dyn_leftArm();
    // Get instance field reference: public RootMotion.FinalIK.IKSolverVR/Arm rightArm
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolverVR::Arm*& dyn_rightArm();
    // Get instance field reference: public RootMotion.FinalIK.IKSolverVR/Leg leftLeg
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolverVR::Leg*& dyn_leftLeg();
    // Get instance field reference: public RootMotion.FinalIK.IKSolverVR/Leg rightLeg
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolverVR::Leg*& dyn_rightLeg();
    // Get instance field reference: public RootMotion.FinalIK.IKSolverVR/Locomotion locomotion
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolverVR::Locomotion*& dyn_locomotion();
    // Get instance field reference: private RootMotion.FinalIK.IKSolverVR/Leg[] legs
    [[deprecated("Use field access instead!")]] ::ArrayW<::RootMotion::FinalIK::IKSolverVR::Leg*>& dyn_legs();
    // Get instance field reference: private RootMotion.FinalIK.IKSolverVR/Arm[] arms
    ...
    // private System.Void Read(UnityEngine.Vector3[] positions, UnityEngine.Quaternion[] rotations, System.Boolean hasChest, System.Boolean hasNeck, System.Boolean hasShoulders, System.Boolean hasToes)
    // Offset: 0x209A55C
    void Read(::ArrayW<::UnityEngine::Vector3> positions, ::ArrayW<::UnityEngine::Quaternion> rotations, bool hasChest, bool hasNeck, bool hasShoulders, bool hasToes);
  ...
  #pragma pack(pop)
  static check_size<sizeof(IKSolverVR), 356 + sizeof(::UnityEngine::Vector3)> __RootMotion_FinalIK_IKSolverVRSizeCheck;
  static_assert(sizeof(IKSolverVR) == 0x170);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Il2CppName: Read
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::IKSolverVR::*)(::ArrayW<::UnityEngine::Vector3>, ::ArrayW<::UnityEngine::Quaternion>, bool, bool, bool, bool)>(&RootMotion::FinalIK::IKSolverVR::Read)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(RootMotion::FinalIK::IKSolverVR*), "Read", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{positions, rotations, hasChest, hasNeck, hasShoulders, hasToes});
  }
};
