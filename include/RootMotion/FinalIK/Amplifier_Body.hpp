...
namespace RootMotion::FinalIK {
  ...
  class Amplifier::Body : public ::Il2CppObject {
    ...
    class EffectorLink;
    public:
    // [TooltipAttribute] Offset: 0xAC8AC4
    ...
    // [TooltipAttribute] Offset: 0xAC8AFC
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Transform*) == 0x8);
    // [TooltipAttribute] Offset: 0xAC8B34
    ...
    // [TooltipAttribute] Offset: 0xAC8B6C
    ...
    // [TooltipAttribute] Offset: 0xAC8BA4
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xAC8BDC
    ...
    // Get instance field reference: public RootMotion.FinalIK.Amplifier/Body/EffectorLink[] effectorLinks
