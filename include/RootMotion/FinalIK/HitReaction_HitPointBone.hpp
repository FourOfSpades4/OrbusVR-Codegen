...
namespace RootMotion::FinalIK {
  ...
  class HitReaction::HitPointBone : public ::RootMotion::FinalIK::HitReaction::HitPoint {
    ...
    class BoneLink;
    public:
    // [TooltipAttribute] Offset: 0xAC8DB8
    ...
    // [TooltipAttribute] Offset: 0xAC8DF0
    ...
    // Get instance field reference: public RootMotion.FinalIK.HitReaction/HitPointBone/BoneLink[] boneLinks
