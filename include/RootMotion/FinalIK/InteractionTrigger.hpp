...
namespace RootMotion::FinalIK {
  ...
  // [HelpURLAttribute] Offset: AC1AE8
  // [AddComponentMenu] Offset: AC1AE8
  class InteractionTrigger : public ::UnityEngine::MonoBehaviour {
    ...
    class Range;
    public:
    // [TooltipAttribute] Offset: 0xAC5064
    ...
    // Get instance field reference: public RootMotion.FinalIK.InteractionTrigger/Range[] ranges
