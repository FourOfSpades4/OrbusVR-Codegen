...
namespace RootMotion::FinalIK {
  ...
  class HitReaction::HitPoint : public ::Il2CppObject {
    public:
    public:
    // [TooltipAttribute] Offset: 0xAC8C14
    ...
    // [TooltipAttribute] Offset: 0xAC8C4C
    ...
    // [TooltipAttribute] Offset: 0xAC8C84
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAC8CD0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xAC8CE0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xAC8CF0
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAC8D00
