...
namespace RootMotion::FinalIK {
  ...
  class IKSolverVR::Footstep : public ::Il2CppObject {
    ...
    char __padding5[0x3] = {};
    // [CompilerGeneratedAttribute] Offset: 0xAC7488
    ...
    // public System.Void StepTo(UnityEngine.Vector3 p, UnityEngine.Quaternion rootRotation)
    // Offset: 0x20A5E74
    void StepTo(::UnityEngine::Vector3 p, ::UnityEngine::Quaternion rootRotation);
...
// Il2CppName: StepTo
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::IKSolverVR::Footstep::*)(::UnityEngine::Vector3, ::UnityEngine::Quaternion)>(&RootMotion::FinalIK::IKSolverVR::Footstep::StepTo)> {
  static const MethodInfo* get() {
    static auto* p = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector3")->byval_arg;
    static auto* rootRotation = &::il2cpp_utils::GetClassFromName("UnityEngine", "Quaternion")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(RootMotion::FinalIK::IKSolverVR::Footstep*), "StepTo", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{p, rootRotation});
  }
};
