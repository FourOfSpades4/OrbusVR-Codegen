...
namespace RootMotion::FinalIK {
  ...
  class Inertia : public ::RootMotion::FinalIK::OffsetModifier {
    ...
    class Body;
    public:
    // [TooltipAttribute] Offset: 0xAC599C
    ...
    // [TooltipAttribute] Offset: 0xAC59D4
    ...
    public:
    // Get instance field reference: public RootMotion.FinalIK.Inertia/Body[] bodies
    [[deprecated("Use field access instead!")]] ::ArrayW<::RootMotion::FinalIK::Inertia::Body*>& dyn_bodies();
    // Get instance field reference: public RootMotion.FinalIK.OffsetModifier/OffsetLimits[] limits
