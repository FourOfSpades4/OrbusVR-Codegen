...
namespace RootMotion::FinalIK {
  ...
  class IKConstraintBend : public ::Il2CppObject {
    ...
    // [RangeAttribute] Offset: 0xAC4400
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [CompilerGeneratedAttribute] Offset: 0xAC4418
  ...
  #pragma pack(pop)
  static check_size<sizeof(IKConstraintBend), 132 + sizeof(bool)> __RootMotion_FinalIK_IKConstraintBendSizeCheck;
  static_assert(sizeof(IKConstraintBend) == 0x85);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
