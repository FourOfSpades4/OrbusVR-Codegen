...
namespace RootMotion::FinalIK {
  ...
  class HitReaction : public ::RootMotion::FinalIK::OffsetModifier {
    ...
    class HitPointBone;
    public:
    // [TooltipAttribute] Offset: 0xAC58BC
    ...
    // [TooltipAttribute] Offset: 0xAC58F4
    ...
    public:
    // Get instance field reference: public RootMotion.FinalIK.HitReaction/HitPointEffector[] effectorHitPoints
    [[deprecated("Use field access instead!")]] ::ArrayW<::RootMotion::FinalIK::HitReaction::HitPointEffector*>& dyn_effectorHitPoints();
    // Get instance field reference: public RootMotion.FinalIK.HitReaction/HitPointBone[] boneHitPoints
