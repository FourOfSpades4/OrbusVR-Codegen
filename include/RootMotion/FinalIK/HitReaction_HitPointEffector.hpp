...
namespace RootMotion::FinalIK {
  ...
  class HitReaction::HitPointEffector : public ::RootMotion::FinalIK::HitReaction::HitPoint {
    ...
    class EffectorLink;
    public:
    // [TooltipAttribute] Offset: 0xAC8D10
    ...
    // [TooltipAttribute] Offset: 0xAC8D48
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::AnimationCurve*) == 0x8);
    // [TooltipAttribute] Offset: 0xAC8D80
    ...
    // Get instance field reference: public RootMotion.FinalIK.HitReaction/HitPointEffector/EffectorLink[] effectorLinks
