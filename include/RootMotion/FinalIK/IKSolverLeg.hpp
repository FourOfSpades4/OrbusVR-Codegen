...
namespace RootMotion::FinalIK {
  ...
  class IKSolverLeg : public ::RootMotion::FinalIK::IKSolver {
    public:
    public:
    // [RangeAttribute] Offset: 0xAC4674
    ...
    // Get instance field reference: public RootMotion.FinalIK.IKSolver/Point pelvis
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolver::Point*& dyn_pelvis();
    // Get instance field reference: public RootMotion.FinalIK.IKSolver/Point thigh
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolver::Point*& dyn_thigh();
    // Get instance field reference: public RootMotion.FinalIK.IKSolver/Point calf
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolver::Point*& dyn_calf();
    // Get instance field reference: public RootMotion.FinalIK.IKSolver/Point foot
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolver::Point*& dyn_foot();
    // Get instance field reference: public RootMotion.FinalIK.IKSolver/Point toe
    [[deprecated("Use field access instead!")]] ::RootMotion::FinalIK::IKSolver::Point*& dyn_toe();
    // Get instance field reference: public RootMotion.FinalIK.IKSolverVR/Leg leg
