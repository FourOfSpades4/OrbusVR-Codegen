...
namespace RootMotion::FinalIK {
  ...
  class InteractionObject::Multiplier : public ::Il2CppObject {
    public:
    public:
    // [TooltipAttribute] Offset: 0xAC8590
    ...
    // [TooltipAttribute] Offset: 0xAC85C8
    ...
    // [TooltipAttribute] Offset: 0xAC8600
    ...
    static_assert(sizeof(::RootMotion::FinalIK::InteractionObject::WeightCurve::Type) == 0x4);
    public:
    // Get instance field reference: public RootMotion.FinalIK.InteractionObject/WeightCurve/Type curve
    ...
    // Get instance field reference: public RootMotion.FinalIK.InteractionObject/WeightCurve/Type result
