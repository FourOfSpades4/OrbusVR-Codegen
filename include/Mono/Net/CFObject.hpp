...
// Including type: ObjCRuntimeInternal.INativeObject
#include "ObjCRuntimeInternal/INativeObject.hpp"
...
namespace Mono::Net {
  ...
  class CFObject : public ::Il2CppObject/*, public ::System::IDisposable, public ::ObjCRuntimeInternal::INativeObject*/ {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xA667DC
    ...
    // Creating interface conversion operator: operator ::ObjCRuntimeInternal::INativeObject
    operator ::ObjCRuntimeInternal::INativeObject() noexcept {
      return *reinterpret_cast<::ObjCRuntimeInternal::INativeObject*>(this);
    }
