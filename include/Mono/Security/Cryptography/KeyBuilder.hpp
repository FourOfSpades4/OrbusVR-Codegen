...
// Writing MetadataGetter for method: Mono::Security::Cryptography::KeyBuilder::IV
// Il2CppName: IV
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t> (*)(int)>(&Mono::Security::Cryptography::KeyBuilder::IV)> {
  static const MethodInfo* get() {
    static auto* size = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(Mono::Security::Cryptography::KeyBuilder*), "IV", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{size});
  }
};
