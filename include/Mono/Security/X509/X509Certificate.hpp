...
namespace Mono::Security::X509 {
  ...
  #pragma pack(pop)
  static check_size<sizeof(X509Certificate), 176 + sizeof(::Mono::Security::X509::X509ExtensionCollection*)> __Mono_Security_X509_X509CertificateSizeCheck;
  static_assert(sizeof(X509Certificate) == 0xB8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
