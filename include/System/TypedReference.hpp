...
namespace System {
  ...
  // [CLSCompliantAttribute] Offset: A57F5C
  // [ComVisibleAttribute] Offset: A57F5C
  struct TypedReference/*, public ::System::ValueType*/ {
    ...
    // static public System.Object ToObject(System.TypedReference value)
    // Offset: 0x1EF2EE8
    static ::Il2CppObject* ToObject(::System::TypedReference value);
...
// Writing MetadataGetter for method: System::TypedReference::ToObject
// Il2CppName: ToObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppObject* (*)(::System::TypedReference)>(&System::TypedReference::ToObject)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "TypedReference")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::TypedReference), "ToObject", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: System::TypedReference::InternalToObject
// Il2CppName: InternalToObject
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Il2CppObject* (*)(void*)>(&System::TypedReference::InternalToObject)> {
  static const MethodInfo* get() {
    static auto* value = &il2cpp_functions::Class_GetPtrClass(::il2cpp_utils::GetClassFromName("System", "Void"))->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::TypedReference), "InternalToObject", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
