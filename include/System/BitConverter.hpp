...
namespace System {
  ...
  class BitConverter : public ::Il2CppObject {
    ...
    // static public System.Boolean ToBoolean(System.Byte[] value, System.Int32 startIndex)
    // Offset: 0x190C044
    static bool ToBoolean(::ArrayW<uint8_t> value, int startIndex);
...
// Writing MetadataGetter for method: System::BitConverter::ToBoolean
// Il2CppName: ToBoolean
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::ArrayW<uint8_t>, int)>(&System::BitConverter::ToBoolean)> {
  static const MethodInfo* get() {
    static auto* value = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Byte"), 1)->byval_arg;
    static auto* startIndex = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::BitConverter*), "ToBoolean", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value, startIndex});
  }
};
