...
namespace System::Collections {
  ...
  // [DebuggerTypeProxyAttribute] Offset: A5D6BC
  // [ComVisibleAttribute] Offset: A5D6BC
  // [DebuggerDisplayAttribute] Offset: A5D6BC
  class Queue : public ::Il2CppObject/*, public ::System::Collections::ICollection, public ::System::ICloneable*/ {
    public:
    // Nested type: ::System::Collections::Queue::SynchronizedQueue
    ...
    // static field const value: static private System.Int32 _MinimumGrow
    static constexpr const int _MinimumGrow = 4;
    // Get static field: static private System.Int32 _MinimumGrow
    static int _get__MinimumGrow();
    // Set static field: static private System.Int32 _MinimumGrow
    static void _set__MinimumGrow(int value);
    // static field const value: static private System.Int32 _ShrinkThreshold
    static constexpr const int _ShrinkThreshold = 32;
    // Get static field: static private System.Int32 _ShrinkThreshold
    static int _get__ShrinkThreshold();
    // Set static field: static private System.Int32 _ShrinkThreshold
    static void _set__ShrinkThreshold(int value);
    ...
    // Offset: 0x1A7AF78
    ::Il2CppObject* Peek();
    // static public System.Collections.Queue Synchronized(System.Collections.Queue queue)
    // Offset: 0x1A7B05C
...
// Writing MetadataGetter for method: System::Collections::Queue::Synchronized
// Il2CppName: Synchronized
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Queue* (*)(::System::Collections::Queue*)>(&System::Collections::Queue::Synchronized)> {
  static const MethodInfo* get() {
    static auto* queue = &::il2cpp_utils::GetClassFromName("System.Collections", "Queue")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Collections::Queue*), "Synchronized", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{queue});
  }
};
