...
namespace System::Collections {
  ...
  // [ComVisibleAttribute] Offset: A5D35C
  // [ObsoleteAttribute] Offset: A5D35C
...
// Writing MetadataGetter for method: System::Collections::CaseInsensitiveHashCodeProvider::_cctor
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&System::Collections::CaseInsensitiveHashCodeProvider::_cctor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::Collections::CaseInsensitiveHashCodeProvider*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: System::Collections::CaseInsensitiveHashCodeProvider::New_ctor
// Il2CppName: .ctor
