...
namespace System::Threading {
  ...
  // [ComVisibleAttribute] Offset: A5A328
  class WaitHandle : public ::System::MarshalByRefObject/*, public ::System::IDisposable*/ {
    ...
    // static public System.Boolean WaitAll(System.Threading.WaitHandle[] waitHandles)
    // Offset: 0x1D00A4C
    static bool WaitAll(::ArrayW<::System::Threading::WaitHandle*> waitHandles);
...
// Il2CppName: WaitAll
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::ArrayW<::System::Threading::WaitHandle*>)>(&System::Threading::WaitHandle::WaitAll)> {
  static const MethodInfo* get() {
    static auto* waitHandles = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System.Threading", "WaitHandle"), 1)->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Threading::WaitHandle*), "WaitAll", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{waitHandles});
  }
};
