...
namespace System::Text::RegularExpressions {
  ...
  class RegexReplacement : public ::Il2CppObject {
    ...
    // static System.String[] Split(System.Text.RegularExpressions.Regex regex, System.String input, System.Int32 count, System.Int32 startat)
    // Offset: 0x21CC980
...
// Writing MetadataGetter for method: System::Text::RegularExpressions::RegexReplacement::Split
// Il2CppName: Split
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::StringW> (*)(::System::Text::RegularExpressions::Regex*, ::StringW, int, int)>(&System::Text::RegularExpressions::RegexReplacement::Split)> {
  static const MethodInfo* get() {
    static auto* regex = &::il2cpp_utils::GetClassFromName("System.Text.RegularExpressions", "Regex")->byval_arg;
    static auto* input = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* count = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* startat = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Text::RegularExpressions::RegexReplacement*), "Split", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{regex, input, count, startat});
  }
};
