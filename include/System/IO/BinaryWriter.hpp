...
namespace System::IO {
  ...
  // [ComVisibleAttribute] Offset: A59944
  class BinaryWriter : public ::Il2CppObject/*, public ::System::IDisposable*/ {
    ...
    // [OptionalFieldAttribute] Offset: 0xA5F6F4
...
// Writing MetadataGetter for method: System::IO::BinaryWriter::get_BaseStream
// Il2CppName: get_BaseStream
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IO::Stream* (System::IO::BinaryWriter::*)()>(&System::IO::BinaryWriter::get_BaseStream)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::IO::BinaryWriter*), "get_BaseStream", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
