...
namespace System::Xml::Schema {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SchemaAttDef), 112 + sizeof(::System::Xml::Schema::SchemaAttDef::Reserve)> __System_Xml_Schema_SchemaAttDefSizeCheck;
  static_assert(sizeof(SchemaAttDef) == 0x74);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
