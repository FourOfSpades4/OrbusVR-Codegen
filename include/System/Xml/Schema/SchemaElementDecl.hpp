...
namespace System::Xml::Schema {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SchemaElementDecl), 128 + sizeof(::System::Xml::Schema::XmlSchemaAnyAttribute*)> __System_Xml_Schema_SchemaElementDeclSizeCheck;
  static_assert(sizeof(SchemaElementDecl) == 0x88);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
