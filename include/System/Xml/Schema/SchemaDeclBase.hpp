...
namespace System::Xml::Schema {
  ...
  #pragma pack(pop)
  static check_size<sizeof(SchemaDeclBase), 80 + sizeof(::System::Collections::Generic::List_1<::StringW>*)> __System_Xml_Schema_SchemaDeclBaseSizeCheck;
  static_assert(sizeof(SchemaDeclBase) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
