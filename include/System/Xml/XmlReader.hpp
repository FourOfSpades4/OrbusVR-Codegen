...
namespace System::Xml {
  ...
  // [DefaultMemberAttribute] Offset: A69680
  // [DebuggerDisplayAttribute] Offset: A69680
  // [DebuggerDisplayAttribute] Offset: A69680
...
// Writing MetadataGetter for method: System::Xml::XmlReader::get_Item
// Il2CppName: get_Item
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (System::Xml::XmlReader::*)(::StringW)>(&System::Xml::XmlReader::get_Item)> {
  static const MethodInfo* get() {
    static auto* name = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(System::Xml::XmlReader*), "get_Item", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{name});
  }
};
