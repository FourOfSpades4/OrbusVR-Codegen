...
namespace System {
  ...
  // [ComVisibleAttribute] Offset: A5818C
  class AssemblyLoadEventArgs : public ::System::EventArgs {
    ...
    // public System.Reflection.Assembly get_LoadedAssembly()
    // Offset: 0x1908314
...
// Writing MetadataGetter for method: System::AssemblyLoadEventArgs::get_LoadedAssembly
// Il2CppName: get_LoadedAssembly
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Reflection::Assembly* (System::AssemblyLoadEventArgs::*)()>(&System::AssemblyLoadEventArgs::get_LoadedAssembly)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(System::AssemblyLoadEventArgs*), "get_LoadedAssembly", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
