...
namespace System::Net::Security {
  ...
  class SslStream : public ::System::Net::Security::AuthenticatedStream {
    ...
    // Offset: 0x16276E0
    ::Mono::Security::Interface::IMonoSslStream* get_Impl();
    // static private Mono.Security.Interface.MonoTlsProvider GetProvider()
    // Offset: 0x1627790
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Mono::Security::Interface::MonoTlsProvider* (*)()>(&System::Net::Security::SslStream::GetProvider)> {
  static const MethodInfo* get() {
