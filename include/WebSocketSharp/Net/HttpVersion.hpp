...
NEED_NO_BOX(::WebSocketSharp::Net::HttpVersion);
DEFINE_IL2CPP_ARG_TYPE(::WebSocketSharp::Net::HttpVersion*, "WebSocketSharp.Net", "HttpVersion");
// Type namespace: WebSocketSharp.Net
namespace WebSocketSharp::Net {
  // Size: 0x10
  #pragma pack(push, 1)
  // Autogenerated type: WebSocketSharp.Net.HttpVersion
...
// Writing MetadataGetter for method: WebSocketSharp::Net::HttpVersion::_cctor
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&WebSocketSharp::Net::HttpVersion::_cctor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(WebSocketSharp::Net::HttpVersion*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
