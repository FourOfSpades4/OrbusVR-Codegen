...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MB3_MultiMeshBaker), 72 + sizeof(::DigitalOpus::MB::Core::MB3_MultiMeshCombiner*)> __GlobalNamespace_MB3_MultiMeshBakerSizeCheck;
  static_assert(sizeof(MB3_MultiMeshBaker) == 0x50);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
