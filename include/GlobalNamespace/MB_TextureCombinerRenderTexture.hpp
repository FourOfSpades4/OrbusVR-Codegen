...
namespace GlobalNamespace {
  ...
  class MB_TextureCombinerRenderTexture : public ::Il2CppObject {
    ...
    // private System.Boolean IsOpenGL()
    // Offset: 0x19F9524
    bool IsOpenGL();
    ...
    // private System.Void _printTexture(UnityEngine.Texture2D t)
    // Offset: 0x19F90C8
    void _printTexture(::UnityEngine::Texture2D* t);
...
// Writing MetadataGetter for method: GlobalNamespace::MB_TextureCombinerRenderTexture::IsOpenGL
// Il2CppName: IsOpenGL
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::MB_TextureCombinerRenderTexture::*)()>(&GlobalNamespace::MB_TextureCombinerRenderTexture::IsOpenGL)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MB_TextureCombinerRenderTexture*), "IsOpenGL", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MB_TextureCombinerRenderTexture::*)(::DigitalOpus::MB::Core::MB_TexSet*, ::DigitalOpus::MB::Core::MeshBakerMaterialTexture*, ::UnityEngine::Vector2, ::UnityEngine::Vector2, ::UnityEngine::Rect, ::DigitalOpus::MB::Core::ShaderTextureProperty*, ::DigitalOpus::MB::Core::MB3_TextureCombinerNonTextureProperties*)>(&GlobalNamespace::MB_TextureCombinerRenderTexture::CopyScaledAndTiledToAtlas)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::MB_TextureCombinerRenderTexture*), "CopyScaledAndTiledToAtlas", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{texSet, source, obUVoffset, obUVscale, rec, texturePropertyName, resultMatTexBlender});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::MB_TextureCombinerRenderTexture::_printTexture
// Il2CppName: _printTexture
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MB_TextureCombinerRenderTexture::*)(::UnityEngine::Texture2D*)>(&GlobalNamespace::MB_TextureCombinerRenderTexture::_printTexture)> {
  static const MethodInfo* get() {
