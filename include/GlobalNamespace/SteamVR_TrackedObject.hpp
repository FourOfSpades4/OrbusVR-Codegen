...
namespace GlobalNamespace {
  ...
  class SteamVR_TrackedObject : public ::UnityEngine::MonoBehaviour {
    ...
    char __padding0[0x4] = {};
    // [TooltipAttribute] Offset: 0xADCC98
    ...
    // [TooltipAttribute] Offset: 0xADCCD0
    // public UnityEngine.Transform indexOrigin
    // Size: 0x8
    // Offset: 0x28
    ::UnityEngine::Transform* indexOrigin;
    // Field size check
    static_assert(sizeof(::UnityEngine::Transform*) == 0x8);
    // private OrbusTrackedController otcObject
    // Size: 0x8
    // Offset: 0x30
    ::GlobalNamespace::OrbusTrackedController* otcObject;
    // Field size check
    static_assert(sizeof(::GlobalNamespace::OrbusTrackedController*) == 0x8);
    // [CompilerGeneratedAttribute] Offset: 0xADCD08
    ...
    // Get instance field reference: public UnityEngine.Transform indexOrigin
    [[deprecated("Use field access instead!")]] ::UnityEngine::Transform*& dyn_indexOrigin();
    // Get instance field reference: private OrbusTrackedController otcObject
    [[deprecated("Use field access instead!")]] ::GlobalNamespace::OrbusTrackedController*& dyn_otcObject();
  ...
  #pragma pack(pop)
  static check_size<sizeof(SteamVR_TrackedObject), 64 + sizeof(::GlobalNamespace::SteamVR_Events::Action*)> __GlobalNamespace_SteamVR_TrackedObjectSizeCheck;
  static_assert(sizeof(SteamVR_TrackedObject) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_TrackedObject::Start
// Il2CppName: Start
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::SteamVR_TrackedObject::*)()>(&GlobalNamespace::SteamVR_TrackedObject::Start)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_TrackedObject*), "Start", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
