...
namespace GlobalNamespace {
  ...
  class TeleportDestination : public ::UnityEngine::MonoBehaviour {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xADBD8C
    ...
    char __padding0[0x7] = {};
    // [TooltipAttribute] Offset: 0xADBD9C
    ...
    // [TooltipAttribute] Offset: 0xADBDD4
    ...
    // Field size check
    static_assert(sizeof(::UnityEngine::Transform*) == 0x8);
    // [TooltipAttribute] Offset: 0xADBE0C
    ...
    char __padding7[0x7] = {};
    // [CompilerGeneratedAttribute] Offset: 0xADBE44
