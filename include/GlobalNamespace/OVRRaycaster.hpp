...
namespace GlobalNamespace {
  ...
  // [RequireComponent] Offset: AB6AA8
  class OVRRaycaster : public ::UnityEngine::UI::GraphicRaycaster/*, public ::UnityEngine::EventSystems::IPointerEnterHandler*/ {
    ...
    public:
    // [TooltipAttribute] Offset: 0xAB9D94
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRRaycaster), 80 + sizeof(::System::Collections::Generic::List_1<::GlobalNamespace::OVRRaycaster::RaycastHit>*)> __GlobalNamespace_OVRRaycasterSizeCheck;
  static_assert(sizeof(OVRRaycaster) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
