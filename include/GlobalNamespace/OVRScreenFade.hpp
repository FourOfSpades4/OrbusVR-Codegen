...
namespace GlobalNamespace {
  ...
  class OVRScreenFade : public ::UnityEngine::MonoBehaviour {
    public:
    // Nested type: ::GlobalNamespace::OVRScreenFade::$Fade$d__28
    class $Fade$d__28;
    public:
    // [TooltipAttribute] Offset: 0xAB9DDC
    ...
    // [TooltipAttribute] Offset: 0xAB9E14
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // private System.Single focusFadeAlpha
    // Size: 0x4
    // Offset: 0x40
    float focusFadeAlpha;
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // Padding between fields: focusFadeAlpha and: fadeRenderer
    char __padding7[0x4] = {};
    ...
    // private UnityEngine.Material focusMaterial
    // Size: 0x8
    // Offset: 0x60
    ::UnityEngine::Material* focusMaterial;
    // Field size check
    static_assert(sizeof(::UnityEngine::Material*) == 0x8);
    ...
    // Get instance field reference: private System.Single focusFadeAlpha
    [[deprecated("Use field access instead!")]] float& dyn_focusFadeAlpha();
    ...
    // Get instance field reference: private UnityEngine.Material focusMaterial
    [[deprecated("Use field access instead!")]] ::UnityEngine::Material*& dyn_focusMaterial();
    ...
    // public System.Void SetFocusFadeLevel(System.Single level)
    // Offset: 0x14D2974
    void SetFocusFadeLevel(float level);
    ...
    // private System.Void SetFocusMaterialAlpha()
    // Offset: 0x14D297C
    void SetFocusMaterialAlpha();
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRScreenFade), 104 + sizeof(bool)> __GlobalNamespace_OVRScreenFadeSizeCheck;
  static_assert(sizeof(OVRScreenFade) == 0x69);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: GlobalNamespace::OVRScreenFade::SetFocusFadeLevel
// Il2CppName: SetFocusFadeLevel
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRScreenFade::*)(float)>(&GlobalNamespace::OVRScreenFade::SetFocusFadeLevel)> {
  static const MethodInfo* get() {
    static auto* level = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OVRScreenFade*), "SetFocusFadeLevel", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{level});
  }
};
...
// Writing MetadataGetter for method: GlobalNamespace::OVRScreenFade::SetFocusMaterialAlpha
// Il2CppName: SetFocusMaterialAlpha
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRScreenFade::*)()>(&GlobalNamespace::OVRScreenFade::SetFocusMaterialAlpha)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::OVRScreenFade*), "SetFocusMaterialAlpha", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
