...
NEED_NO_BOX(::GlobalNamespace::MB3_KMeansClustering::DataPoint);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::MB3_KMeansClustering::DataPoint*, "", "MB3_KMeansClustering/DataPoint");
// Type namespace: 
namespace GlobalNamespace {
  // Size: 0x2C
  #pragma pack(push, 1)
  // Autogenerated type: MB3_KMeansClustering/DataPoint
  ...
  class MB3_KMeansClustering::DataPoint : public ::Il2CppObject {
    ...
    static MB3_KMeansClustering::DataPoint* New_ctor(::UnityEngine::GameObject* go) {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::MB3_KMeansClustering::DataPoint::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<MB3_KMeansClustering::DataPoint*, creationType>(go)));
    }
  }; // MB3_KMeansClustering/DataPoint
  #pragma pack(pop)
  static check_size<sizeof(MB3_KMeansClustering::DataPoint), 40 + sizeof(int)> __GlobalNamespace_MB3_KMeansClustering_DataPointSizeCheck;
  static_assert(sizeof(MB3_KMeansClustering::DataPoint) == 0x2C);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: GlobalNamespace::MB3_KMeansClustering::DataPoint::New_ctor
// Il2CppName: .ctor
