...
// Type namespace: 
namespace GlobalNamespace {
  // Forward declaring type: SteamVR_LoadLevel_Custom
  class SteamVR_LoadLevel_Custom;
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
NEED_NO_BOX(::GlobalNamespace::SteamVR_LoadLevel_Custom);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::SteamVR_LoadLevel_Custom*, "", "SteamVR_LoadLevel_Custom");
// Type namespace: 
namespace GlobalNamespace {
  // Size: 0xF1
  #pragma pack(push, 1)
  // Autogenerated type: SteamVR_LoadLevel_Custom
  // [TokenAttribute] Offset: FFFFFFFF
  class SteamVR_LoadLevel_Custom : public ::UnityEngine::MonoBehaviour {
    public:
    // Nested type: ::GlobalNamespace::SteamVR_LoadLevel_Custom::$LoadLevel$d__44
    class $LoadLevel$d__44;
    public:
    ...
    static ::GlobalNamespace::SteamVR_LoadLevel_Custom* _get__active();
    // Set static field: static private SteamVR_LoadLevel_Custom _active
    static void _set__active(::GlobalNamespace::SteamVR_LoadLevel_Custom* value);
    ...
    static SteamVR_LoadLevel_Custom* New_ctor() {
      static auto ___internal__logger = ::Logger::get().WithContext("::GlobalNamespace::SteamVR_LoadLevel_Custom::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<SteamVR_LoadLevel_Custom*, creationType>()));
    }
    // static private System.Void .cctor()
    // Offset: 0xE0DFFC
    static void _cctor();
  }; // SteamVR_LoadLevel_Custom
  #pragma pack(pop)
  static check_size<sizeof(SteamVR_LoadLevel_Custom), 240 + sizeof(bool)> __GlobalNamespace_SteamVR_LoadLevel_CustomSizeCheck;
  static_assert(sizeof(SteamVR_LoadLevel_Custom) == 0xF1);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::get_loading
// Il2CppName: get_loading
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)()>(&GlobalNamespace::SteamVR_LoadLevel_Custom::get_loading)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), "get_loading", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::get_progress
// Il2CppName: get_progress
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (*)()>(&GlobalNamespace::SteamVR_LoadLevel_Custom::get_progress)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), "get_progress", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::get_progressTexture
// Il2CppName: get_progressTexture
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Texture* (*)()>(&GlobalNamespace::SteamVR_LoadLevel_Custom::get_progressTexture)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), "get_progressTexture", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::OnEnable
// Il2CppName: OnEnable
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::SteamVR_LoadLevel_Custom::*)()>(&GlobalNamespace::SteamVR_LoadLevel_Custom::OnEnable)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), "OnEnable", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::Trigger
// Il2CppName: Trigger
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::SteamVR_LoadLevel_Custom::*)()>(&GlobalNamespace::SteamVR_LoadLevel_Custom::Trigger)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), "Trigger", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::Begin
// Il2CppName: Begin
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::StringW, bool, float, float, float, float, float)>(&GlobalNamespace::SteamVR_LoadLevel_Custom::Begin)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), "Begin", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{levelName, showGrid, fadeOutTime, r, g, b, a});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::Update
// Il2CppName: Update
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::SteamVR_LoadLevel_Custom::*)()>(&GlobalNamespace::SteamVR_LoadLevel_Custom::Update)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), "Update", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::LoadLevel
// Il2CppName: LoadLevel
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::IEnumerator* (GlobalNamespace::SteamVR_LoadLevel_Custom::*)()>(&GlobalNamespace::SteamVR_LoadLevel_Custom::LoadLevel)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), "LoadLevel", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::GetOverlayHandle
// Il2CppName: GetOverlayHandle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint64_t (GlobalNamespace::SteamVR_LoadLevel_Custom::*)(::StringW, ::UnityEngine::Transform*, float)>(&GlobalNamespace::SteamVR_LoadLevel_Custom::GetOverlayHandle)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), "GetOverlayHandle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{overlayName, transform, widthInMeters});
  }
};
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::New_ctor
// Il2CppName: .ctor
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: GlobalNamespace::SteamVR_LoadLevel_Custom::_cctor
// Il2CppName: .cctor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&GlobalNamespace::SteamVR_LoadLevel_Custom::_cctor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(GlobalNamespace::SteamVR_LoadLevel_Custom*), ".cctor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
