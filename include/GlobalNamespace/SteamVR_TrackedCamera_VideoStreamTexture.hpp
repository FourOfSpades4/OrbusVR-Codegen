...
namespace GlobalNamespace {
  ...
  class SteamVR_TrackedCamera::VideoStreamTexture : public ::Il2CppObject {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xADCC68
    ...
    char __padding0[0x3] = {};
    // [CompilerGeneratedAttribute] Offset: 0xADCC78
    ...
    // Field size check
    static_assert(sizeof(::Valve::VR::CameraVideoStreamFrameHeader_t) == 0x70);
    public:
  ...
  static_assert(sizeof(SteamVR_TrackedCamera::VideoStreamTexture) == 0xB0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
