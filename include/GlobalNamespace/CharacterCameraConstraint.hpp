...
namespace GlobalNamespace {
  ...
  class CharacterCameraConstraint : public ::UnityEngine::MonoBehaviour {
    public:
    public:
    // [TooltipAttribute] Offset: 0xADB698
    ...
    // [TooltipAttribute] Offset: 0xADB6D0
    ...
    // [TooltipAttribute] Offset: 0xADB708
    ...
    // [TooltipAttribute] Offset: 0xADB740
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xADB778
