...
namespace GlobalNamespace {
  ...
  class TeleportAimHandlerParabolic : public ::GlobalNamespace::TeleportAimHandler {
    ...
    public:
    // [TooltipAttribute] Offset: 0xADBBF8
    ...
    // [TooltipAttribute] Offset: 0xADBC30
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [TooltipAttribute] Offset: 0xADBC68
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xADBCA0
    // [TooltipAttribute] Offset: 0xADBCA0
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xADBCFC
    // [TooltipAttribute] Offset: 0xADBCFC
