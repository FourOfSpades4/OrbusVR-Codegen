...
namespace GlobalNamespace {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MB3_MeshBakerCommon), 64 + sizeof(::UnityEngine::GameObject*)> __GlobalNamespace_MB3_MeshBakerCommonSizeCheck;
  static_assert(sizeof(MB3_MeshBakerCommon) == 0x48);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
