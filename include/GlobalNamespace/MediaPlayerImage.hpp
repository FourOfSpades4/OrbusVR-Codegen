...
namespace GlobalNamespace {
  ...
  class MediaPlayerImage : public ::UnityEngine::UI::Image {
    public:
    // Writing base type padding for base size: 0xDE to desired offset: 0xE0
  ...
  #pragma pack(pop)
  static check_size<sizeof(MediaPlayerImage), 224 + sizeof(::GlobalNamespace::MediaPlayerImage::ButtonType)> __GlobalNamespace_MediaPlayerImageSizeCheck;
  static_assert(sizeof(MediaPlayerImage) == 0xE4);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
