...
namespace DigitalOpus::MB::Core {
  ...
  class MB3_TextureCombinerPackerMeshBaker : public ::DigitalOpus::MB::Core::MB3_TextureCombinerPackerRoot {
    public:
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBaker::$CreateAtlases$d__0
    class $CreateAtlases$d__0;
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBaker::$CopyScaledAndTiledToAtlas$d__1
    class $CopyScaledAndTiledToAtlas$d__1;
