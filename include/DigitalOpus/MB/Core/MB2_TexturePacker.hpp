...
namespace DigitalOpus::MB::Core {
  ...
  class MB2_TexturePacker : public ::Il2CppObject {
    ...
    // public System.Void normalizeRects(DigitalOpus.MB.Core.AtlasPackingResult rr, DigitalOpus.MB.Core.AtlasPadding padding)
    // Offset: 0xDF52E0
    void normalizeRects(::DigitalOpus::MB::Core::AtlasPackingResult* rr, ::DigitalOpus::MB::Core::AtlasPadding padding);
...
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB2_TexturePacker::normalizeRects
// Il2CppName: normalizeRects
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB2_TexturePacker::*)(::DigitalOpus::MB::Core::AtlasPackingResult*, ::DigitalOpus::MB::Core::AtlasPadding)>(&DigitalOpus::MB::Core::MB2_TexturePacker::normalizeRects)> {
  static const MethodInfo* get() {
    static auto* rr = &::il2cpp_utils::GetClassFromName("DigitalOpus.MB.Core", "AtlasPackingResult")->byval_arg;
    static auto* padding = &::il2cpp_utils::GetClassFromName("DigitalOpus.MB.Core", "AtlasPadding")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB2_TexturePacker*), "normalizeRects", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{rr, padding});
  }
};
