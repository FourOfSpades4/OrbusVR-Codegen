...
namespace DigitalOpus::MB::Core {
  ...
  class MB3_TextureCombinerPackerOneTextureInAtlas : public ::Il2CppObject/*, public ::DigitalOpus::MB::Core::MB_ITextureCombinerPacker*/ {
    public:
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPackerOneTextureInAtlas::$ConvertTexturesToReadableFormats$d__0
    class $ConvertTexturesToReadableFormats$d__0;
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPackerOneTextureInAtlas::$CreateAtlases$d__2
