...
namespace DigitalOpus::MB::Core {
  ...
  class MB_TexSet : public ::Il2CppObject {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAE115C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAE116C
    ...
    char __padding3[0x2] = {};
    // [CompilerGeneratedAttribute] Offset: 0xAE117C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAE118C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAE119C
    ...
    // public System.Void CreateColoredTexToReplaceNull(System.String propName, System.Int32 propIdx, System.Boolean considerMeshUVs, DigitalOpus.MB.Core.MB3_TextureCombiner combiner, UnityEngine.Color col)
    // Offset: 0xF387CC
    void CreateColoredTexToReplaceNull(::StringW propName, int propIdx, bool considerMeshUVs, ::DigitalOpus::MB::Core::MB3_TextureCombiner* combiner, ::UnityEngine::Color col);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (DigitalOpus::MB::Core::MB_TexSet::*)(::StringW, int, bool, ::DigitalOpus::MB::Core::MB3_TextureCombiner*, ::UnityEngine::Color)>(&DigitalOpus::MB::Core::MB_TexSet::CreateColoredTexToReplaceNull)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB_TexSet*), "CreateColoredTexToReplaceNull", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{propName, propIdx, considerMeshUVs, combiner, col});
  }
};
