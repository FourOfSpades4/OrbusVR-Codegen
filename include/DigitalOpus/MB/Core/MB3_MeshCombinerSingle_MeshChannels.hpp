...
namespace DigitalOpus::MB::Core {
  ...
  #pragma pack(pop)
  static check_size<sizeof(MB3_MeshCombinerSingle::MeshChannels), 112 + sizeof(::ArrayW<::DigitalOpus::MB::Core::MB3_MeshCombinerSingle::MBBlendShape*>)> __DigitalOpus_MB_Core_MB3_MeshCombinerSingle_MeshChannelsSizeCheck;
  static_assert(sizeof(MB3_MeshCombinerSingle::MeshChannels) == 0x78);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
