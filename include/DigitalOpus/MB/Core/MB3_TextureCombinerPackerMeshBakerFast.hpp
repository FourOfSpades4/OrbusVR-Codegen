...
namespace DigitalOpus::MB::Core {
  ...
  class MB3_TextureCombinerPackerMeshBakerFast : public ::Il2CppObject/*, public ::DigitalOpus::MB::Core::MB_ITextureCombinerPacker*/ {
    public:
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerFast::$ConvertTexturesToReadableFormats$d__0
    class $ConvertTexturesToReadableFormats$d__0;
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerFast::$CreateAtlases$d__2
