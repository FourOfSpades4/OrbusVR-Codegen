...
namespace DigitalOpus::MB::Core {
  ...
  class MB3_TextureCombinerPipeline : public ::Il2CppObject {
    ...
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::$$c__DisplayClass5_0
    class $$c__DisplayClass5_0;
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::$$c__DisplayClass5_1
    class $$c__DisplayClass5_1;
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::$$c__DisplayClass8_0
    class $$c__DisplayClass8_0;
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::$$c__DisplayClass8_1
    class $$c__DisplayClass8_1;
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::$__Step1_CollectDistinctMatTexturesAndUsedObjects$d__8
    class $__Step1_CollectDistinctMatTexturesAndUsedObjects$d__8;
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::$CalculateIdealSizesForTexturesInAtlasAndPadding$d__10
    class $CalculateIdealSizesForTexturesInAtlasAndPadding$d__10;
    // Nested type: ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::$__Step3_BuildAndSaveAtlasesAndStoreResults$d__13
    class $__Step3_BuildAndSaveAtlasesAndStoreResults$d__13;
    // Size: 0x3
    #pragma pack(push, 1)
    ...
    struct CreateAtlasForProperty/*, public ::System::ValueType*/ {
      ...
      constexpr CreateAtlasForProperty(bool allTexturesAreNull_ = {}, bool allTexturesAreSame_ = {}, bool allNonTexturePropsAreSame_ = {}) noexcept : allTexturesAreNull{allTexturesAreNull_}, allTexturesAreSame{allTexturesAreSame_}, allNonTexturePropsAreSame{allNonTexturePropsAreSame_} {}
    ...
    #pragma pack(pop)
    static check_size<sizeof(MB3_TextureCombinerPipeline::CreateAtlasForProperty), 2 + sizeof(bool)> __DigitalOpus_MB_Core_MB3_TextureCombinerPipeline_CreateAtlasForPropertySizeCheck;
    static_assert(sizeof(MB3_TextureCombinerPipeline::CreateAtlasForProperty) == 0x3);
    ...
    // static System.Boolean _ShouldWeCreateAtlasForThisProperty(System.Int32 propertyIndex, DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/CreateAtlasForProperty[] allTexturesAreNullAndSameColor, DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data)
    // Offset: 0x18FBAE4
    static bool _ShouldWeCreateAtlasForThisProperty(int propertyIndex, ::ArrayW<::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::CreateAtlasForProperty> allTexturesAreNullAndSameColor, ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::TexturePipelineData* data);
    ...
    // static System.Collections.IEnumerator CalculateIdealSizesForTexturesInAtlasAndPadding(DigitalOpus.MB.Core.ProgressUpdateDelegate progressInfo, DigitalOpus.MB.Core.MB3_TextureCombiner/CombineTexturesIntoAtlasesCoroutineResult result, DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data, DigitalOpus.MB.Core.MB3_TextureCombiner combiner, DigitalOpus.MB.Core.MB2_EditorMethodsInterface textureEditorMethods, DigitalOpus.MB.Core.MB2_LogLevel LOG_LEVEL)
    // Offset: 0x18EAAA4
    static ::System::Collections::IEnumerator* CalculateIdealSizesForTexturesInAtlasAndPadding(::DigitalOpus::MB::Core::ProgressUpdateDelegate* progressInfo, ::DigitalOpus::MB::Core::MB3_TextureCombiner_CombineTexturesIntoAtlasesCoroutineResult* result, ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::TexturePipelineData* data, ::DigitalOpus::MB::Core::MB3_TextureCombiner* combiner, ::DigitalOpus::MB::Core::MB2_EditorMethodsInterface* textureEditorMethods, ::DigitalOpus::MB::Core::MB2_LogLevel LOG_LEVEL);
    // static DigitalOpus.MB.Core.AtlasPackingResult[] __Step3_RunTexturePacker(DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data, DigitalOpus.MB.Core.MB_ITextureCombinerPacker texturePacker, DigitalOpus.MB.Core.MB2_LogLevel LOG_LEVEL)
    // Offset: 0x18EC358
    static ::ArrayW<::DigitalOpus::MB::Core::AtlasPackingResult*> __Step3_RunTexturePacker(::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::TexturePipelineData* data, ::DigitalOpus::MB::Core::MB_ITextureCombinerPacker* texturePacker, ::DigitalOpus::MB::Core::MB2_LogLevel LOG_LEVEL);
    // static DigitalOpus.MB.Core.MB_ITextureCombinerPacker CreatePacker(System.Boolean onlyOneTextureInAtlasReuseTextures, DigitalOpus.MB.Core.MB2_PackingAlgorithmEnum packingAlgorithm)
    // Offset: 0x18EBA4C
    static ::DigitalOpus::MB::Core::MB_ITextureCombinerPacker* CreatePacker(bool onlyOneTextureInAtlasReuseTextures, ::DigitalOpus::MB::Core::MB2_PackingAlgorithmEnum packingAlgorithm);
    // static System.Collections.IEnumerator __Step3_BuildAndSaveAtlasesAndStoreResults(DigitalOpus.MB.Core.MB3_TextureCombiner/CombineTexturesIntoAtlasesCoroutineResult result, DigitalOpus.MB.Core.ProgressUpdateDelegate progressInfo, DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data, DigitalOpus.MB.Core.MB3_TextureCombiner combiner, DigitalOpus.MB.Core.MB_ITextureCombinerPacker packer, DigitalOpus.MB.Core.AtlasPackingResult atlasPackingResult, DigitalOpus.MB.Core.MB2_EditorMethodsInterface textureEditorMethods, MB_AtlasesAndRects resultAtlasesAndRects, System.Text.StringBuilder report, DigitalOpus.MB.Core.MB2_LogLevel LOG_LEVEL)
    // Offset: 0x18EBBAC
    ...
    // static System.Text.StringBuilder GenerateReport(DigitalOpus.MB.Core.MB3_TextureCombinerPipeline/TexturePipelineData data)
    // Offset: 0x18EAB3C
    static ::System::Text::StringBuilder* GenerateReport(::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::TexturePipelineData* data);
...
// Il2CppName: _ShouldWeCreateAtlasForThisProperty
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(int, ::ArrayW<::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::CreateAtlasForProperty>, ::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::TexturePipelineData*)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::_ShouldWeCreateAtlasForThisProperty)> {
  static const MethodInfo* get() {
    static auto* propertyIndex = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* allTexturesAreNullAndSameColor = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("DigitalOpus.MB.Core", "MB3_TextureCombinerPipeline/CreateAtlasForProperty"), 1)->byval_arg;
    static auto* data = &::il2cpp_utils::GetClassFromName("DigitalOpus.MB.Core", "MB3_TextureCombinerPipeline/TexturePipelineData")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPipeline*), "_ShouldWeCreateAtlasForThisProperty", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{propertyIndex, allTexturesAreNullAndSameColor, data});
  }
};
...
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::__Step3_RunTexturePacker
// Il2CppName: __Step3_RunTexturePacker
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::DigitalOpus::MB::Core::AtlasPackingResult*> (*)(::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::TexturePipelineData*, ::DigitalOpus::MB::Core::MB_ITextureCombinerPacker*, ::DigitalOpus::MB::Core::MB2_LogLevel)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::__Step3_RunTexturePacker)> {
  static const MethodInfo* get() {
    static auto* data = &::il2cpp_utils::GetClassFromName("DigitalOpus.MB.Core", "MB3_TextureCombinerPipeline/TexturePipelineData")->byval_arg;
    static auto* texturePacker = &::il2cpp_utils::GetClassFromName("DigitalOpus.MB.Core", "MB_ITextureCombinerPacker")->byval_arg;
    static auto* LOG_LEVEL = &::il2cpp_utils::GetClassFromName("DigitalOpus.MB.Core", "MB2_LogLevel")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(DigitalOpus::MB::Core::MB3_TextureCombinerPipeline*), "__Step3_RunTexturePacker", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{data, texturePacker, LOG_LEVEL});
  }
};
// Writing MetadataGetter for method: DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::CreatePacker
// Il2CppName: CreatePacker
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::DigitalOpus::MB::Core::MB_ITextureCombinerPacker* (*)(bool, ::DigitalOpus::MB::Core::MB2_PackingAlgorithmEnum)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::CreatePacker)> {
  static const MethodInfo* get() {
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Text::StringBuilder* (*)(::DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::TexturePipelineData*)>(&DigitalOpus::MB::Core::MB3_TextureCombinerPipeline::GenerateReport)> {
  static const MethodInfo* get() {
    static auto* data = &::il2cpp_utils::GetClassFromName("DigitalOpus.MB.Core", "MB3_TextureCombinerPipeline/TexturePipelineData")->byval_arg;
