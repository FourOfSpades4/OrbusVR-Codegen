...
namespace DigitalOpus::MB::Core {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ShaderTextureProperty), 24 + sizeof(bool)> __DigitalOpus_MB_Core_ShaderTexturePropertySizeCheck;
  static_assert(sizeof(ShaderTextureProperty) == 0x19);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
