...
namespace UnityEngine {
  ...
  class WWWForm : public ::Il2CppObject {
    ...
    // public System.Void AddBinaryData(System.String fieldName, System.Byte[] contents)
    // Offset: 0x2855778
    void AddBinaryData(::StringW fieldName, ::ArrayW<uint8_t> contents);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::WWWForm::*)(::StringW, ::ArrayW<uint8_t>)>(&UnityEngine::WWWForm::AddBinaryData)> {
  static const MethodInfo* get() {
    static auto* fieldName = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    static auto* contents = &il2cpp_functions::array_class_get(::il2cpp_utils::GetClassFromName("System", "Byte"), 1)->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::WWWForm*), "AddBinaryData", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{fieldName, contents});
  }
};
// Writing MetadataGetter for method: UnityEngine::WWWForm::AddBinaryData
// Il2CppName: AddBinaryData
