...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: A7092C
  // [NativeClassAttribute] Offset: A7092C
  // [RequiredByNativeCodeAttribute] Offset: A7092C
  ...
  class ScriptableObject : public ::UnityEngine::Object {
    ...
    // static private UnityEngine.ScriptableObject CreateScriptableObjectInstanceFromType(System.Type type)
    // Offset: 0x1F97E9C
    static ::UnityEngine::ScriptableObject* CreateScriptableObjectInstanceFromType(::System::Type* type);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ScriptableObject* (*)(::System::Type*)>(&UnityEngine::ScriptableObject::CreateScriptableObjectInstanceFromType)> {
  static const MethodInfo* get() {
    static auto* type = &::il2cpp_utils::GetClassFromName("System", "Type")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ScriptableObject*), "CreateScriptableObjectInstanceFromType", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{type});
  }
};
