...
namespace UnityEngine::Timeline {
  ...
  // [TrackBindingTypeAttribute] Offset: AACDC4
  // [TrackClipTypeAttribute] Offset: AACDC4
  ...
  #pragma pack(pop)
  static check_size<sizeof(ActivationTrack), 128 + sizeof(::UnityEngine::Timeline::ActivationMixerPlayable*)> __UnityEngine_Timeline_ActivationTrackSizeCheck;
  static_assert(sizeof(ActivationTrack) == 0x88);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: UnityEngine::Timeline::ActivationTrack::get_compilable
// Il2CppName: get_compilable
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::Timeline::ActivationTrack::*)()>(&UnityEngine::Timeline::ActivationTrack::get_compilable)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::ActivationTrack*), "get_compilable", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
