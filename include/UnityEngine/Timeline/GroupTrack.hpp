...
namespace UnityEngine::Timeline {
  ...
  // [TrackClipTypeAttribute] Offset: AACB8C
  // [SupportsChildTracksAttribute] Offset: AACB8C
...
// Writing MetadataGetter for method: UnityEngine::Timeline::GroupTrack::get_compilable
// Il2CppName: get_compilable
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::Timeline::GroupTrack::*)()>(&UnityEngine::Timeline::GroupTrack::get_compilable)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::GroupTrack*), "get_compilable", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
