...
namespace UnityEngine::Timeline {
  ...
  class ParticleControlPlayable : public ::UnityEngine::Playables::PlayableBehaviour {
    ...
    char __padding2[0x4] = {};
    // [CompilerGeneratedAttribute] Offset: 0xAADBD0
    // [DebuggerBrowsableAttribute] Offset: 0xAADBD0
    ...
    public:
    // Get instance field reference: private System.Single m_LastTime
    [[deprecated("Use field access instead!")]] float& dyn_m_LastTime();
    // Get instance field reference: private System.UInt32 m_RandomSeed
    [[deprecated("Use field access instead!")]] uint& dyn_m_RandomSeed();
    // Get instance field reference: private System.Single m_SystemTime
    [[deprecated("Use field access instead!")]] float& dyn_m_SystemTime();
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Timeline::ParticleControlPlayable::*)()>(&UnityEngine::Timeline::ParticleControlPlayable::SetRandomSeed)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::ParticleControlPlayable*), "SetRandomSeed", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
