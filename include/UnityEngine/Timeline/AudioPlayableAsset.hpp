...
namespace UnityEngine::Timeline {
  ...
  class AudioPlayableAsset : public ::UnityEngine::Playables::PlayableAsset/*, public ::UnityEngine::Timeline::ITimelineClipAsset*/ {
    public:
    // Nested type: ::UnityEngine::Timeline::AudioPlayableAsset::$$c__Iterator0
    class $$c__Iterator0;
    public:
  ...
  #pragma pack(pop)
  static check_size<sizeof(AudioPlayableAsset), 36 + sizeof(float)> __UnityEngine_Timeline_AudioPlayableAssetSizeCheck;
  static_assert(sizeof(AudioPlayableAsset) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
