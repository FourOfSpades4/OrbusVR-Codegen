...
namespace UnityEngine::Timeline {
  ...
  class TimelineClip : public ::Il2CppObject/*, public ::UnityEngine::ISerializationCallbackReceiver*/ {
    public:
    ...
    // [FormerlySerializedAsAttribute] Offset: 0xAAD31C
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xAAD488
    // [CompilerGeneratedAttribute] Offset: 0xAAD488
    // private System.Int32 <dirtyHash>k__BackingField
    // Size: 0x4
    // Offset: 0xB0
    int dirtyHash;
    // Field size check
    ...
    // Get instance field reference: private System.Int32 <dirtyHash>k__BackingField
    [[deprecated("Use field access instead!")]] int& dyn_$dirtyHash$k__BackingField();
  ...
  #pragma pack(pop)
  static check_size<sizeof(TimelineClip), 180 + sizeof(int)> __UnityEngine_Timeline_TimelineClipSizeCheck;
