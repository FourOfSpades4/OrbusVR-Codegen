...
namespace UnityEngine::Timeline {
  ...
  #pragma pack(pop)
  static check_size<sizeof(TimelineAsset::EditorSettings), 16 + sizeof(float)> __UnityEngine_Timeline_TimelineAsset_EditorSettingsSizeCheck;
  static_assert(sizeof(TimelineAsset::EditorSettings) == 0x14);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
