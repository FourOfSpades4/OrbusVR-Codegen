...
namespace UnityEngine::Timeline {
  ...
  class TimelineAsset : public ::UnityEngine::Playables::PlayableAsset/*, public ::UnityEngine::ISerializationCallbackReceiver, public ::UnityEngine::Timeline::ITimelineClipAsset, public ::UnityEngine::Timeline::IPropertyPreview*/ {
    ...
    // Nested type: ::UnityEngine::Timeline::TimelineAsset::$$c__Iterator0
    class $$c__Iterator0;
    // Size: 0x4
    #pragma pack(push, 1)
    ...
    public:
    // private System.Int32 m_NextId
    // Size: 0x4
    // Offset: 0x18
    int m_NextId;
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // Padding between fields: m_NextId and: m_Tracks
    char __padding0[0x4] = {};
    ...
    // Get instance field reference: private System.Int32 m_NextId
    [[deprecated("Use field access instead!")]] int& dyn_m_NextId();
    ...
    // public T CreateTrack(UnityEngine.Timeline.TrackAsset parent, System.String name)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class T>
    T CreateTrack(::UnityEngine::Timeline::TrackAsset* parent, ::StringW name) {
      ...
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod(this, "CreateTrack", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(parent), ::il2cpp_utils::ExtractType(name)})));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()}));
      return ::il2cpp_utils::RunMethodRethrow<T, false>(this, ___generic__method, parent, name);
    }
    ...
    // private System.Void DeleteRecordingClip(UnityEngine.Timeline.TrackAsset track)
    // Offset: 0x1D9D4F4
    void DeleteRecordingClip(::UnityEngine::Timeline::TrackAsset* track);
  ...
  #pragma pack(pop)
  static check_size<sizeof(TimelineAsset), 84 + sizeof(int)> __UnityEngine_Timeline_TimelineAssetSizeCheck;
  static_assert(sizeof(TimelineAsset) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Writing MetadataGetter for method: UnityEngine::Timeline::TimelineAsset::GenerateNewId
// Il2CppName: GenerateNewId
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (UnityEngine::Timeline::TimelineAsset::*)()>(&UnityEngine::Timeline::TimelineAsset::GenerateNewId)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimelineAsset*), "GenerateNewId", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Timeline::TimelineAsset::CalculateDuration
// Il2CppName: CalculateDuration
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<double (UnityEngine::Timeline::TimelineAsset::*)()>(&UnityEngine::Timeline::TimelineAsset::CalculateDuration)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimelineAsset*), "CalculateDuration", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Timeline::TimelineAsset::DeleteRecordingClip
// Il2CppName: DeleteRecordingClip
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Timeline::TimelineAsset::*)(::UnityEngine::Timeline::TrackAsset*)>(&UnityEngine::Timeline::TimelineAsset::DeleteRecordingClip)> {
  static const MethodInfo* get() {
    static auto* track = &::il2cpp_utils::GetClassFromName("UnityEngine.Timeline", "TrackAsset")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Timeline::TimelineAsset*), "DeleteRecordingClip", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{track});
  }
};
