...
namespace UnityEngine::Timeline {
  ...
  class AnimationOutputWeightProcessor : public ::Il2CppObject/*, public ::UnityEngine::Timeline::ITimelineEvaluateCallback*/ {
    ...
    struct WeightInfo/*, public ::System::ValueType*/ {
      ...
      // public System.Boolean modulate
      // Size: 0x1
      // Offset: 0x24
      bool modulate;
      // Field size check
      ...
      constexpr WeightInfo(::UnityEngine::Playables::Playable mixer_ = {}, ::UnityEngine::Playables::Playable parentMixer_ = {}, int port_ = {}, bool modulate_ = {}) noexcept : mixer{mixer_}, parentMixer{parentMixer_}, port{port_}, modulate{modulate_} {}
      ...
      // Get instance field reference: public System.Boolean modulate
      [[deprecated("Use field access instead!")]] bool& dyn_modulate();
    }; // UnityEngine.Timeline.AnimationOutputWeightProcessor/WeightInfo
    #pragma pack(pop)
    static check_size<sizeof(AnimationOutputWeightProcessor::WeightInfo), 36 + sizeof(bool)> __UnityEngine_Timeline_AnimationOutputWeightProcessor_WeightInfoSizeCheck;
    static_assert(sizeof(AnimationOutputWeightProcessor::WeightInfo) == 0x25);
    public:
    ...
    // Padding between fields: m_MotionXPlayable and: m_PoseMixer
    char __padding1[0x4] = {};
    // private UnityEngine.Animations.AnimationMixerPlayable m_PoseMixer
    // Size: 0xC
    // Offset: 0x30
    ::UnityEngine::Animations::AnimationMixerPlayable m_PoseMixer;
    // Field size check
    static_assert(sizeof(::UnityEngine::Animations::AnimationMixerPlayable) == 0xC);
    // Padding between fields: m_PoseMixer and: m_LayerMixer
    char __padding2[0x4] = {};
    // private UnityEngine.Animations.AnimationLayerMixerPlayable m_LayerMixer
    // Size: 0xC
    // Offset: 0x40
    ::UnityEngine::Animations::AnimationLayerMixerPlayable m_LayerMixer;
    // Field size check
    static_assert(sizeof(::UnityEngine::Animations::AnimationLayerMixerPlayable) == 0xC);
    // Padding between fields: m_LayerMixer and: m_Mixers
    char __padding3[0x4] = {};
    ...
    // Get instance field reference: private UnityEngine.Animations.AnimationMixerPlayable m_PoseMixer
    [[deprecated("Use field access instead!")]] ::UnityEngine::Animations::AnimationMixerPlayable& dyn_m_PoseMixer();
    // Get instance field reference: private UnityEngine.Animations.AnimationLayerMixerPlayable m_LayerMixer
    [[deprecated("Use field access instead!")]] ::UnityEngine::Animations::AnimationLayerMixerPlayable& dyn_m_LayerMixer();
  ...
  #pragma pack(pop)
  static check_size<sizeof(AnimationOutputWeightProcessor), 80 + sizeof(::System::Collections::Generic::List_1<::UnityEngine::Timeline::AnimationOutputWeightProcessor::WeightInfo>*)> __UnityEngine_Timeline_AnimationOutputWeightProcessorSizeCheck;
  static_assert(sizeof(AnimationOutputWeightProcessor) == 0x58);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
