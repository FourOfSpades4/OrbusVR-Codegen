...
namespace UnityEngine::Audio {
  ...
  // [NativeHeaderAttribute] Offset: A85D64
  // [NativeHeaderAttribute] Offset: A85D64
  // [StaticAccessorAttribute] Offset: A85D64
  // [RequiredByNativeCodeAttribute] Offset: A85D64
  // [NativeHeaderAttribute] Offset: A85D64
  struct AudioMixerPlayable/*, public ::System::ValueType, public ::UnityEngine::Playables::IPlayable, public ::System::IEquatable_1<::UnityEngine::Audio::AudioMixerPlayable>*/ {
    ...
    // static private System.Boolean CreateAudioMixerPlayableInternal(ref UnityEngine.Playables.PlayableGraph graph, System.Int32 inputCount, System.Boolean normalizeInputVolumes, ref UnityEngine.Playables.PlayableHandle handle)
    // Offset: 0x2847ACC
    static bool CreateAudioMixerPlayableInternal(ByRef<::UnityEngine::Playables::PlayableGraph> graph, int inputCount, bool normalizeInputVolumes, ByRef<::UnityEngine::Playables::PlayableHandle> handle);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(ByRef<::UnityEngine::Playables::PlayableGraph>, int, bool, ByRef<::UnityEngine::Playables::PlayableHandle>)>(&UnityEngine::Audio::AudioMixerPlayable::CreateAudioMixerPlayableInternal)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Audio::AudioMixerPlayable), "CreateAudioMixerPlayableInternal", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{graph, inputCount, normalizeInputVolumes, handle});
  }
};
