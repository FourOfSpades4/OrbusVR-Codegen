...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: A70BDC
  // [NativeHeaderAttribute] Offset: A70BDC
  // [NativeHeaderAttribute] Offset: A70BDC
  // [NativeHeaderAttribute] Offset: A70BDC
  // [NativeHeaderAttribute] Offset: A70BDC
  class SystemInfo : public ::Il2CppObject {
    ...
    // static public System.Boolean get_supportsRenderTextures()
    // Offset: 0x1F9C7F0
    static bool get_supportsRenderTextures();
    // static public System.Boolean get_supportsImageEffects()
    // Offset: 0x1F9C7F8
    ...
    // static private System.Boolean SupportsImageEffects()
    // Offset: 0x1F9C7FC
    static bool SupportsImageEffects();
...
// Writing MetadataGetter for method: UnityEngine::SystemInfo::get_supportsRenderTextures
// Il2CppName: get_supportsRenderTextures
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)()>(&UnityEngine::SystemInfo::get_supportsRenderTextures)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::SystemInfo*), "get_supportsRenderTextures", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::SystemInfo::get_supportsImageEffects
// Il2CppName: get_supportsImageEffects
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)()>(&UnityEngine::SystemInfo::get_supportsImageEffects)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::SystemInfo*), "get_supportsImageEffects", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::SystemInfo::SupportsImageEffects
// Il2CppName: SupportsImageEffects
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)()>(&UnityEngine::SystemInfo::SupportsImageEffects)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::SystemInfo*), "SupportsImageEffects", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
