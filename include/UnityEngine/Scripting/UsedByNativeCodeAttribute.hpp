...
namespace UnityEngine::Scripting {
  ...
  // [VisibleToOtherModulesAttribute] Offset: A6B950
  // [AttributeUsageAttribute] Offset: A6B950
  class UsedByNativeCodeAttribute : public ::System::Attribute {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xA6BF28
    // [CompilerGeneratedAttribute] Offset: 0xA6BF28
