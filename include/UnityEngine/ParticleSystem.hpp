...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: A9DB44
  // [NativeHeaderAttribute] Offset: A9DB44
  // [UsedByNativeCodeAttribute] Offset: A9DB44
  // [RequireComponent] Offset: A9DB44
  // [NativeHeaderAttribute] Offset: A9DB44
  // [RequireComponent] Offset: A9DB44
  // [NativeHeaderAttribute] Offset: A9DB44
  class ParticleSystem : public ::UnityEngine::Component {
    ...
    // [TokenAttribute] Offset: FFFFFFFF
    // [RequiredByNativeCodeAttribute] Offset: A9DC70
    ...
    #pragma pack(pop)
    static check_size<sizeof(ParticleSystem::Particle), 120 + sizeof(uint)> __UnityEngine_ParticleSystem_ParticleSizeCheck;
    static_assert(sizeof(ParticleSystem::Particle) == 0x7C);
    ...
    // private System.Void Internal_EmitOld(ref UnityEngine.ParticleSystem/Particle particle)
    // Offset: 0x28951AC
    void Internal_EmitOld(ByRef<::UnityEngine::ParticleSystem::Particle> particle);
...
// Writing MetadataGetter for method: UnityEngine::ParticleSystem::Internal_EmitOld
// Il2CppName: Internal_EmitOld
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::ParticleSystem::*)(ByRef<::UnityEngine::ParticleSystem::Particle>)>(&UnityEngine::ParticleSystem::Internal_EmitOld)> {
  static const MethodInfo* get() {
    static auto* particle = &::il2cpp_utils::GetClassFromName("UnityEngine", "ParticleSystem/Particle")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::ParticleSystem*), "Internal_EmitOld", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{particle});
  }
};
