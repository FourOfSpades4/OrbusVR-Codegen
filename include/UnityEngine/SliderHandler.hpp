...
namespace UnityEngine {
  ...
  struct SliderHandler/*, public ::System::ValueType*/ {
    ...
    constexpr SliderHandler(::UnityEngine::Rect position_ = {}, float currentValue_ = {}, float size_ = {}, float start_ = {}, float end_ = {}, ::UnityEngine::GUIStyle* slider_ = {}, ::UnityEngine::GUIStyle* thumb_ = {}, bool horiz_ = {}, int id_ = {}) noexcept : position{position_}, currentValue{currentValue_}, size{size_}, start{start_}, end{end_}, slider{slider_}, thumb{thumb_}, horiz{horiz_}, id{id_} {}
    ...
    // public System.Void .ctor(UnityEngine.Rect position, System.Single currentValue, System.Single size, System.Single start, System.Single end, UnityEngine.GUIStyle slider, UnityEngine.GUIStyle thumb, System.Boolean horiz, System.Int32 id)
    // Offset: 0xBB9B9C
    // ABORTED: conflicts with another method.  SliderHandler(::UnityEngine::Rect position, float currentValue, float size, float start, float end, ::UnityEngine::GUIStyle* slider, ::UnityEngine::GUIStyle* thumb, bool horiz, int id);
  ...
  #pragma pack(pop)
  static check_size<sizeof(SliderHandler), 52 + sizeof(int)> __UnityEngine_SliderHandlerSizeCheck;
  static_assert(sizeof(SliderHandler) == 0x38);
}
