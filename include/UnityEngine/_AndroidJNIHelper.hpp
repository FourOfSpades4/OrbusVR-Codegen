...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: A6D960
  class _AndroidJNIHelper : public ::Il2CppObject {
    ...
    // static public System.IntPtr CreateJavaProxy(System.Int32 delegateHandle, UnityEngine.AndroidJavaProxy proxy)
    // Offset: 0x283B4F8
    static ::System::IntPtr CreateJavaProxy(int delegateHandle, ::UnityEngine::AndroidJavaProxy* proxy);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IntPtr (*)(int, ::UnityEngine::AndroidJavaProxy*)>(&UnityEngine::_AndroidJNIHelper::CreateJavaProxy)> {
