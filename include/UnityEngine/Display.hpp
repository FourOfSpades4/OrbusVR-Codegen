...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: A6E57C
  // [NativeHeaderAttribute] Offset: A6E57C
  class Display : public ::Il2CppObject {
    ...
    // [DebuggerBrowsableAttribute] Offset: 0xA72C30
    // [CompilerGeneratedAttribute] Offset: 0xA72C30
