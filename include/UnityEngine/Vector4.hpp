...
namespace UnityEngine {
  ...
  // [DefaultMemberAttribute] Offset: A711FC
  // [NativeHeaderAttribute] Offset: A711FC
  // [RequiredByNativeCodeAttribute] Offset: A711FC
  // [NativeClassAttribute] Offset: A711FC
  struct Vector4/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::Vector4>*/ {
    ...
    // static public System.Single SqrMagnitude(UnityEngine.Vector4 a)
    // Offset: 0x283B000
    static float SqrMagnitude(::UnityEngine::Vector4 a);
...
// Writing MetadataGetter for method: UnityEngine::Vector4::SqrMagnitude
// Il2CppName: SqrMagnitude
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (*)(::UnityEngine::Vector4)>(&UnityEngine::Vector4::SqrMagnitude)> {
  static const MethodInfo* get() {
    static auto* a = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector4")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Vector4), "SqrMagnitude", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{a});
  }
};
