...
namespace UnityEngine::EventSystems {
  ...
  // [AddComponentMenu] Offset: AAE3A4
  class EventSystem : public ::UnityEngine::EventSystems::UIBehaviour {
    ...
    // [FormerlySerializedAsAttribute] Offset: 0xAAF440
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAAF4AC
    // Get static field: static private System.Comparison`1<UnityEngine.EventSystems.RaycastResult> <>f__mg$cache0
    static ::System::Comparison_1<::UnityEngine::EventSystems::RaycastResult>* _get_$$f__mg$cache0();
    // Set static field: static private System.Comparison`1<UnityEngine.EventSystems.RaycastResult> <>f__mg$cache0
    static void _set_$$f__mg$cache0(::System::Comparison_1<::UnityEngine::EventSystems::RaycastResult>* value);
