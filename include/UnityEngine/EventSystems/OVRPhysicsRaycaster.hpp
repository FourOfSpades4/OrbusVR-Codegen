...
namespace UnityEngine::EventSystems {
  ...
  // [RequireComponent] Offset: AB6C88
  ...
  #pragma pack(pop)
  static check_size<sizeof(OVRPhysicsRaycaster), 28 + sizeof(int)> __UnityEngine_EventSystems_OVRPhysicsRaycasterSizeCheck;
  static_assert(sizeof(OVRPhysicsRaycaster) == 0x20);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
