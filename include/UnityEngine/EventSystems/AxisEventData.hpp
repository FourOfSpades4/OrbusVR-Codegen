...
namespace UnityEngine::EventSystems {
  ...
  class AxisEventData : public ::UnityEngine::EventSystems::BaseEventData {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xAAF66C
    // [DebuggerBrowsableAttribute] Offset: 0xAAF66C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAAF6A8
    // [DebuggerBrowsableAttribute] Offset: 0xAAF6A8
