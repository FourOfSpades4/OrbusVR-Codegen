...
namespace UnityEngine::EventSystems {
  ...
  // [AddComponentMenu] Offset: AAE54C
  // [RequireComponent] Offset: AAE54C
  ...
  #pragma pack(pop)
  static check_size<sizeof(Physics2DRaycaster), 56 + sizeof(::ArrayW<::UnityEngine::RaycastHit2D>)> __UnityEngine_EventSystems_Physics2DRaycasterSizeCheck;
  static_assert(sizeof(Physics2DRaycaster) == 0x40);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
