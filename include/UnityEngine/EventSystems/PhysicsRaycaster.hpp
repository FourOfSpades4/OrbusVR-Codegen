...
namespace UnityEngine::EventSystems {
  ...
  // [AddComponentMenu] Offset: AAE5D4
  // [RequireComponent] Offset: AAE5D4
  class PhysicsRaycaster : public ::UnityEngine::EventSystems::BaseRaycaster {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAAFC70
    // Get static field: static private System.Comparison`1<UnityEngine.RaycastHit> <>f__am$cache0
    static ::System::Comparison_1<::UnityEngine::RaycastHit>* _get_$$f__am$cache0();
    // Set static field: static private System.Comparison`1<UnityEngine.RaycastHit> <>f__am$cache0
    static void _set_$$f__am$cache0(::System::Comparison_1<::UnityEngine::RaycastHit>* value);
    ...
    // static private System.Int32 <Raycast>m__0(UnityEngine.RaycastHit r1, UnityEngine.RaycastHit r2)
    // Offset: 0x17D5C24
    static int $Raycast$m__0(::UnityEngine::RaycastHit r1, ::UnityEngine::RaycastHit r2);
  ...
  #pragma pack(pop)
  static check_size<sizeof(PhysicsRaycaster), 48 + sizeof(::ArrayW<::UnityEngine::RaycastHit>)> __UnityEngine_EventSystems_PhysicsRaycasterSizeCheck;
  static_assert(sizeof(PhysicsRaycaster) == 0x38);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Writing MetadataGetter for method: UnityEngine::EventSystems::PhysicsRaycaster::$Raycast$m__0
// Il2CppName: <Raycast>m__0
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int (*)(::UnityEngine::RaycastHit, ::UnityEngine::RaycastHit)>(&UnityEngine::EventSystems::PhysicsRaycaster::$Raycast$m__0)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::EventSystems::PhysicsRaycaster*), "<Raycast>m__0", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{r1, r2});
  }
};
