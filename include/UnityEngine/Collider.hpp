...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: A81168
  // [RequireComponent] Offset: A81168
  // [RequiredByNativeCodeAttribute] Offset: A81168
  class Collider : public ::UnityEngine::Component {
    ...
    // public UnityEngine.PhysicMaterial get_sharedMaterial()
    // Offset: 0x28720CC
...
// Writing MetadataGetter for method: UnityEngine::Collider::get_sharedMaterial
// Il2CppName: get_sharedMaterial
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::PhysicMaterial* (UnityEngine::Collider::*)()>(&UnityEngine::Collider::get_sharedMaterial)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Collider*), "get_sharedMaterial", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
