...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: A6BE64
  // [VisibleToOtherModulesAttribute] Offset: A6BE64
  class StaticAccessorAttribute : public ::System::Attribute/*, public ::UnityEngine::Bindings::IBindingsAttribute*/ {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xA6C48C
    // [CompilerGeneratedAttribute] Offset: 0xA6C48C
    ...
    // [CompilerGeneratedAttribute] Offset: 0xA6C4C8
    // [DebuggerBrowsableAttribute] Offset: 0xA6C4C8
