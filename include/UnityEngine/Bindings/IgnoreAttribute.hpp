...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: A6BEDC
  // [VisibleToOtherModulesAttribute] Offset: A6BEDC
  class IgnoreAttribute : public ::System::Attribute/*, public ::UnityEngine::Bindings::IBindingsAttribute*/ {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xA6C540
    // [DebuggerBrowsableAttribute] Offset: 0xA6C540
