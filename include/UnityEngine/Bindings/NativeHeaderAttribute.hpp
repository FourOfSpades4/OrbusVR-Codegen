...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: A6BBC8
  // [VisibleToOtherModulesAttribute] Offset: A6BBC8
  class NativeHeaderAttribute : public ::System::Attribute/*, public ::UnityEngine::Bindings::IBindingsHeaderProviderAttribute*/ {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xA6C1BC
    // [DebuggerBrowsableAttribute] Offset: 0xA6C1BC
