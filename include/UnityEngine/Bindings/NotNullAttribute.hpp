...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: A6BD64
  // [VisibleToOtherModulesAttribute] Offset: A6BD64
  class NotNullAttribute : public ::System::Attribute/*, public ::UnityEngine::Bindings::IBindingsAttribute*/ {
    public:
