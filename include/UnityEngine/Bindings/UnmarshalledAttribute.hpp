...
namespace UnityEngine::Bindings {
  ...
  // [AttributeUsageAttribute] Offset: A6BDA0
  // [VisibleToOtherModulesAttribute] Offset: A6BDA0
  class UnmarshalledAttribute : public ::System::Attribute/*, public ::UnityEngine::Bindings::IBindingsAttribute*/ {
    public:
