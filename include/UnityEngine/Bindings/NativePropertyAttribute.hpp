...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: A6BCDC
  // [AttributeUsageAttribute] Offset: A6BCDC
  class NativePropertyAttribute : public ::UnityEngine::Bindings::NativeMethodAttribute {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xA6C39C
    // [CompilerGeneratedAttribute] Offset: 0xA6C39C
    ...
    // public System.Void .ctor(System.String name, UnityEngine.Bindings.TargetType targetType)
    // Offset: 0x289FAD8
    template<::il2cpp_utils::CreationType creationType = ::il2cpp_utils::CreationType::Temporary>
    static NativePropertyAttribute* New_ctor(::StringW name, ::UnityEngine::Bindings::TargetType targetType) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Bindings::NativePropertyAttribute::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<NativePropertyAttribute*, creationType>(name, targetType)));
    }
