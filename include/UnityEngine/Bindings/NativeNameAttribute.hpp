...
namespace UnityEngine::Bindings {
  ...
  // [VisibleToOtherModulesAttribute] Offset: A6BC18
  // [AttributeUsageAttribute] Offset: A6BC18
  class NativeNameAttribute : public ::System::Attribute/*, public ::UnityEngine::Bindings::IBindingsNameProviderAttribute*/ {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xA6C1F8
    // [DebuggerBrowsableAttribute] Offset: 0xA6C1F8
