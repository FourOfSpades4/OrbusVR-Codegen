...
namespace UnityEngine::AI {
  ...
  // [MovedFromAttribute] Offset: A91154
  class NavMeshPath : public ::Il2CppObject {
    ...
    // private System.Void DestroyNavMeshPath()
    // Offset: 0x28A528C
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::AI::NavMeshPath::*)()>(&UnityEngine::AI::NavMeshPath::DestroyNavMeshPath)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::AI::NavMeshPath*), "DestroyNavMeshPath", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
