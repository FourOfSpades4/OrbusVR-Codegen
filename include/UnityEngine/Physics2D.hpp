...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: A9F918
  // [StaticAccessorAttribute] Offset: A9F918
  // [NativeHeaderAttribute] Offset: A9F918
  // [NativeHeaderAttribute] Offset: A9F918
  class Physics2D : public ::Il2CppObject {
    ...
    // static public UnityEngine.Collider2D OverlapPoint(UnityEngine.Vector2 point, System.Int32 layerMask)
    // Offset: 0x2893ED4
    static ::UnityEngine::Collider2D* OverlapPoint(::UnityEngine::Vector2 point, int layerMask);
    // static public UnityEngine.Collider2D OverlapCircle(UnityEngine.Vector2 point, System.Single radius, System.Int32 layerMask)
    // Offset: 0x2893FE4
    static ::UnityEngine::Collider2D* OverlapCircle(::UnityEngine::Vector2 point, float radius, int layerMask);
    // static private System.Void .cctor()
    // Offset: 0x2894108
    static void _cctor();
    // static private System.Void get_defaultPhysicsScene_Injected(out UnityEngine.PhysicsScene2D ret)
    // Offset: 0x2892BFC
    static void get_defaultPhysicsScene_Injected(ByRef<::UnityEngine::PhysicsScene2D> ret);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Collider2D* (*)(::UnityEngine::Vector2, int)>(&UnityEngine::Physics2D::OverlapPoint)> {
  static const MethodInfo* get() {
    static auto* point = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    static auto* layerMask = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Physics2D*), "OverlapPoint", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{point, layerMask});
  }
};
// Writing MetadataGetter for method: UnityEngine::Physics2D::OverlapCircle
// Il2CppName: OverlapCircle
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Collider2D* (*)(::UnityEngine::Vector2, float, int)>(&UnityEngine::Physics2D::OverlapCircle)> {
  static const MethodInfo* get() {
    static auto* point = &::il2cpp_utils::GetClassFromName("UnityEngine", "Vector2")->byval_arg;
    static auto* radius = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    static auto* layerMask = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Physics2D*), "OverlapCircle", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{point, radius, layerMask});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::Physics2D::get_defaultPhysicsScene_Injected
// Il2CppName: get_defaultPhysicsScene_Injected
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(ByRef<::UnityEngine::PhysicsScene2D>)>(&UnityEngine::Physics2D::get_defaultPhysicsScene_Injected)> {
  static const MethodInfo* get() {
    static auto* ret = &::il2cpp_utils::GetClassFromName("UnityEngine", "PhysicsScene2D")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Physics2D*), "get_defaultPhysicsScene_Injected", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ret});
  }
};
