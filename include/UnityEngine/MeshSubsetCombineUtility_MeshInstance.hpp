...
namespace UnityEngine {
  ...
  // Autogenerated type: UnityEngine.MeshSubsetCombineUtility/MeshInstance
  ...
  struct MeshSubsetCombineUtility::MeshInstance/*, public ::System::ValueType*/ {
    ...
    constexpr MeshInstance(int meshInstanceID_ = {}, int rendererInstanceID_ = {}, int additionalVertexStreamsMeshInstanceID_ = {}, ::UnityEngine::Matrix4x4 transform_ = {}, ::UnityEngine::Vector4 lightmapScaleOffset_ = {}, ::UnityEngine::Vector4 realtimeLightmapScaleOffset_ = {}) noexcept : meshInstanceID{meshInstanceID_}, rendererInstanceID{rendererInstanceID_}, additionalVertexStreamsMeshInstanceID{additionalVertexStreamsMeshInstanceID_}, transform{transform_}, lightmapScaleOffset{lightmapScaleOffset_}, realtimeLightmapScaleOffset{realtimeLightmapScaleOffset_} {}
  ...
  #pragma pack(pop)
  static check_size<sizeof(MeshSubsetCombineUtility::MeshInstance), 92 + sizeof(::UnityEngine::Vector4)> __UnityEngine_MeshSubsetCombineUtility_MeshInstanceSizeCheck;
  static_assert(sizeof(MeshSubsetCombineUtility::MeshInstance) == 0x6C);
}
