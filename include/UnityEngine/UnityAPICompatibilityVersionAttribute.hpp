...
namespace UnityEngine {
  ...
  // [AttributeUsageAttribute] Offset: A7102C
  class UnityAPICompatibilityVersionAttribute : public ::System::Attribute {
    ...
    static UnityAPICompatibilityVersionAttribute* New_ctor(::StringW version) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::UnityAPICompatibilityVersionAttribute::.ctor");
      return THROW_UNLESS((::il2cpp_utils::New<UnityAPICompatibilityVersionAttribute*, creationType>(version)));
    }
  }; // UnityEngine.UnityAPICompatibilityVersionAttribute
  #pragma pack(pop)
  static check_size<sizeof(UnityAPICompatibilityVersionAttribute), 16 + sizeof(::StringW)> __UnityEngine_UnityAPICompatibilityVersionAttributeSizeCheck;
  static_assert(sizeof(UnityAPICompatibilityVersionAttribute) == 0x18);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
