...
namespace UnityEngine {
  ...
  // [UsedByNativeCodeAttribute] Offset: A6DEF0
  // [AttributeUsageAttribute] Offset: A6DEF0
  class DefaultExecutionOrder : public ::System::Attribute {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xA72784
    // [CompilerGeneratedAttribute] Offset: 0xA72784
...
// Writing MetadataGetter for method: UnityEngine::DefaultExecutionOrder::set_order
// Il2CppName: set_order
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::DefaultExecutionOrder::*)(int)>(&UnityEngine::DefaultExecutionOrder::set_order)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::DefaultExecutionOrder*), "set_order", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
