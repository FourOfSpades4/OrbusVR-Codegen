...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::IntervalTreeNode, "UnityEngine", "IntervalTreeNode");
// Type namespace: UnityEngine
namespace UnityEngine {
  // Size: 0x18
  #pragma pack(push, 1)
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: UnityEngine.IntervalTreeNode
  ...
  #pragma pack(pop)
  static check_size<sizeof(IntervalTreeNode), 20 + sizeof(int)> __UnityEngine_IntervalTreeNodeSizeCheck;
