...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: AAEA18
  class RawImage : public ::UnityEngine::UI::MaskableGraphic {
    public:
    public:
    // [FormerlySerializedAsAttribute] Offset: 0xAB0C0C
  ...
  #pragma pack(pop)
  static check_size<sizeof(RawImage), 184 + sizeof(::UnityEngine::Rect)> __UnityEngine_UI_RawImageSizeCheck;
  static_assert(sizeof(RawImage) == 0xC8);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
