...
namespace UnityEngine::UI {
  ...
  class ListPool_1 : public ::Il2CppObject {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAB18CC
    // Autogenerated static field getter
    // Get static field: static private UnityEngine.Events.UnityAction`1<System.Collections.Generic.List`1<T>> <>f__mg$cache0
    static ::UnityEngine::Events::UnityAction_1<::System::Collections::Generic::List_1<T>*>* _get_$$f__mg$cache0() {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::UI::ListPool_1::_get_$$f__mg$cache0");
      return THROW_UNLESS((il2cpp_utils::GetFieldValue<::UnityEngine::Events::UnityAction_1<::System::Collections::Generic::List_1<T>*>*>(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ListPool_1<T>*>::get(), "<>f__mg$cache0")));
    }
    // Autogenerated static field setter
    // Set static field: static private UnityEngine.Events.UnityAction`1<System.Collections.Generic.List`1<T>> <>f__mg$cache0
    static void _set_$$f__mg$cache0(::UnityEngine::Events::UnityAction_1<::System::Collections::Generic::List_1<T>*>* value) {
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::UI::ListPool_1::_set_$$f__mg$cache0");
      THROW_UNLESS((il2cpp_utils::SetFieldValue(il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<ListPool_1<T>*>::get(), "<>f__mg$cache0", value)));
    }
