...
namespace UnityEngine::UI {
  ...
  class CanvasUpdateRegistry : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // Padding between fields: m_PerformingGraphicUpdate and: m_LayoutRebuildQueue
    char __padding1[0x6] = {};
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAAFE20
    // Get static field: static private System.Comparison`1<UnityEngine.UI.ICanvasElement> <>f__mg$cache0
    static ::System::Comparison_1<::UnityEngine::UI::ICanvasElement*>* _get_$$f__mg$cache0();
    // Set static field: static private System.Comparison`1<UnityEngine.UI.ICanvasElement> <>f__mg$cache0
    static void _set_$$f__mg$cache0(::System::Comparison_1<::UnityEngine::UI::ICanvasElement*>* value);
  ...
  #pragma pack(pop)
  static check_size<sizeof(CanvasUpdateRegistry), 32 + sizeof(::UnityEngine::UI::Collections::IndexedSet_1<::UnityEngine::UI::ICanvasElement*>*)> __UnityEngine_UI_CanvasUpdateRegistrySizeCheck;
  static_assert(sizeof(CanvasUpdateRegistry) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
