...
namespace UnityEngine::UI {
  ...
  struct SpriteState/*, public ::System::ValueType, public ::System::IEquatable_1<::UnityEngine::UI::SpriteState>*/ {
    ...
    constexpr SpriteState(::UnityEngine::Sprite* m_HighlightedSprite_ = {}, ::UnityEngine::Sprite* m_PressedSprite_ = {}, ::UnityEngine::Sprite* m_DisabledSprite_ = {}) noexcept : m_HighlightedSprite{m_HighlightedSprite_}, m_PressedSprite{m_PressedSprite_}, m_DisabledSprite{m_DisabledSprite_} {}
  ...
  #pragma pack(pop)
  static check_size<sizeof(SpriteState), 16 + sizeof(::UnityEngine::Sprite*)> __UnityEngine_UI_SpriteStateSizeCheck;
  static_assert(sizeof(SpriteState) == 0x18);
}
