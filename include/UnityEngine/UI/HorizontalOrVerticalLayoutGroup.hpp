...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(HorizontalOrVerticalLayoutGroup), 95 + sizeof(bool)> __UnityEngine_UI_HorizontalOrVerticalLayoutGroupSizeCheck;
  static_assert(sizeof(HorizontalOrVerticalLayoutGroup) == 0x60);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
