...
namespace UnityEngine::UI {
  ...
  #pragma pack(pop)
  static check_size<sizeof(ReflectionMethodsCache), 56 + sizeof(::UnityEngine::UI::ReflectionMethodsCache::GetRaycastNonAllocCallback*)> __UnityEngine_UI_ReflectionMethodsCacheSizeCheck;
