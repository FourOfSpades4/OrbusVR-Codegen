...
namespace UnityEngine::UI {
  ...
  class Graphic : public ::UnityEngine::EventSystems::UIBehaviour/*, public ::UnityEngine::UI::ICanvasElement*/ {
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAB0418
    // [DebuggerBrowsableAttribute] Offset: 0xAB0418
  ...
  #pragma pack(pop)
  static check_size<sizeof(Graphic), 120 + sizeof(bool)> __UnityEngine_UI_GraphicSizeCheck;
  static_assert(sizeof(Graphic) == 0x79);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
