...
namespace UnityEngine::UI {
  ...
  class MaskableGraphic : public ::UnityEngine::UI::Graphic/*, public ::UnityEngine::UI::IClippable, public ::UnityEngine::UI::IMaskable, public ::UnityEngine::UI::IMaterialModifier*/ {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // [EditorBrowsableAttribute] Offset: 0xAB0B04
    // [ObsoleteAttribute] Offset: 0xAB0B04
    ...
    // [EditorBrowsableAttribute] Offset: 0xAB0B68
    // [ObsoleteAttribute] Offset: 0xAB0B68
  ...
  #pragma pack(pop)
  static check_size<sizeof(MaskableGraphic), 168 + sizeof(::ArrayW<::UnityEngine::Vector3>)> __UnityEngine_UI_MaskableGraphicSizeCheck;
  static_assert(sizeof(MaskableGraphic) == 0xB0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
