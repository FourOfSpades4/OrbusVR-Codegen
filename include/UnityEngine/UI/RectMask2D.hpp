...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: AAEA54
  // [ExecuteAlways] Offset: FFFFFFFF
  // [DisallowMultipleComponent] Offset: FFFFFFFF
  // [RequireComponent] Offset: AAEA54
  ...
  #pragma pack(pop)
  static check_size<sizeof(RectMask2D), 96 + sizeof(::ArrayW<::UnityEngine::Vector3>)> __UnityEngine_UI_RectMask2DSizeCheck;
  static_assert(sizeof(RectMask2D) == 0x68);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
