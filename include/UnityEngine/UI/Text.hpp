...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: AAED44
  class Text : public ::UnityEngine::UI::MaskableGraphic/*, public ::UnityEngine::UI::ILayoutElement*/ {
    ...
    // [TextAreaAttribute] Offset: 0xAB1280
  ...
  #pragma pack(pop)
  static check_size<sizeof(Text), 216 + sizeof(::ArrayW<::UnityEngine::UIVertex>)> __UnityEngine_UI_TextSizeCheck;
  static_assert(sizeof(Text) == 0xE0);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
