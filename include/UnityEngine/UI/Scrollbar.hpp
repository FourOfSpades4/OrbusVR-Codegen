...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: AAEB00
  // [RequireComponent] Offset: AAEB00
  class Scrollbar : public ::UnityEngine::UI::Selectable/*, public ::UnityEngine::EventSystems::IBeginDragHandler, public ::UnityEngine::EventSystems::IDragHandler, public ::UnityEngine::EventSystems::IInitializePotentialDragHandler, public ::UnityEngine::UI::ICanvasElement*/ {
    ...
    struct Axis;
    // Nested type: ::UnityEngine::UI::Scrollbar::$ClickRepeat$c__Iterator0
    class $ClickRepeat$c__Iterator0;
    // Size: 0x4
    #pragma pack(push, 1)
    ...
    // [RangeAttribute] Offset: 0xAB0C88
    ...
    // [RangeAttribute] Offset: 0xAB0CC8
    ...
    // Field size check
    static_assert(sizeof(float) == 0x4);
    // [RangeAttribute] Offset: 0xAB0D08
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // [SpaceAttribute] Offset: 0xAB0D48
  ...
  #pragma pack(pop)
  static check_size<sizeof(Scrollbar), 280 + sizeof(bool)> __UnityEngine_UI_ScrollbarSizeCheck;
  static_assert(sizeof(Scrollbar) == 0x119);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Il2CppName: Set
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::Scrollbar::*)(float)>(&UnityEngine::UI::Scrollbar::Set)> {
  static const MethodInfo* get() {
    static auto* input = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::Scrollbar*), "Set", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{input});
  }
};
// Writing MetadataGetter for method: UnityEngine::UI::Scrollbar::Set
// Il2CppName: Set
