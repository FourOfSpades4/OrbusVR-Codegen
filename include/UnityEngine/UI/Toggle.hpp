...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: AAED80
  // [RequireComponent] Offset: AAED80
  class Toggle : public ::UnityEngine::UI::Selectable/*, public ::UnityEngine::EventSystems::IPointerClickHandler, public ::UnityEngine::EventSystems::ISubmitHandler, public ::UnityEngine::UI::ICanvasElement*/ {
    ...
    // [TooltipAttribute] Offset: 0xAB12D0
    ...
    // private System.Void Set(System.Boolean value)
    // Offset: 0x1E1D958
    void Set(bool value);
  ...
  #pragma pack(pop)
  static check_size<sizeof(Toggle), 248 + sizeof(bool)> __UnityEngine_UI_ToggleSizeCheck;
  static_assert(sizeof(Toggle) == 0xF9);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
...
// Il2CppName: Set
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::Toggle::*)(bool)>(&UnityEngine::UI::Toggle::Set)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::Toggle*), "Set", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
// Writing MetadataGetter for method: UnityEngine::UI::Toggle::Set
// Il2CppName: Set
