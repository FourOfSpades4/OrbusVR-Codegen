...
namespace UnityEngine::UI {
  ...
  // [AddComponentMenu] Offset: AAE890
  class Image : public ::UnityEngine::UI::MaskableGraphic/*, public ::UnityEngine::ISerializationCallbackReceiver, public ::UnityEngine::UI::ILayoutElement, public ::UnityEngine::ICanvasRaycastFilter*/ {
    ...
    public:
    // [FormerlySerializedAsAttribute] Offset: 0xAB050C
    ...
    // [RangeAttribute] Offset: 0xAB0598
    ...
    // [CompilerGeneratedAttribute] Offset: 0xAB0608
  ...
  #pragma pack(pop)
  static check_size<sizeof(Image), 221 + sizeof(bool)> __UnityEngine_UI_ImageSizeCheck;
  static_assert(sizeof(Image) == 0xDE);
}
#include "beatsaber-hook/shared/utils/il2cpp-type-check.hpp"
