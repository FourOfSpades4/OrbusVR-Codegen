...
namespace UnityEngine::UI {
  ...
  class Clipping : public ::Il2CppObject {
    ...
    // static private UnityEngine.Rect RectIntersect(UnityEngine.Rect a, UnityEngine.Rect b)
    // Offset: 0x17DEDF8
    static ::UnityEngine::Rect RectIntersect(::UnityEngine::Rect a, ::UnityEngine::Rect b);
...
// Writing MetadataGetter for method: UnityEngine::UI::Clipping::RectIntersect
// Il2CppName: RectIntersect
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Rect (*)(::UnityEngine::Rect, ::UnityEngine::Rect)>(&UnityEngine::UI::Clipping::RectIntersect)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::UI::Clipping*), "RectIntersect", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{a, b});
  }
};
