...
namespace UnityEngine {
  ...
  // [StaticAccessorAttribute] Offset: A98D60
  // [NativeHeaderAttribute] Offset: A98D60
  class Event : public ::Il2CppObject {
    ...
    static ::System::Collections::Generic::Dictionary_2<::StringW, int>* _get_$$f__switch$map0();
    // Set static field: static private System.Collections.Generic.Dictionary`2<System.String,System.Int32> <>f__switch$map0
    static void _set_$$f__switch$map0(::System::Collections::Generic::Dictionary_2<::StringW, int>* value);
