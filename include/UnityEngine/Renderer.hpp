...
namespace UnityEngine {
  ...
  // [RequireComponent] Offset: A6EE2C
  // [NativeHeaderAttribute] Offset: A6EE2C
  // [UsedByNativeCodeAttribute] Offset: A6EE2C
  // [NativeHeaderAttribute] Offset: A6EE2C
...
// Writing MetadataGetter for method: UnityEngine::Renderer::set_sortingLayerName
// Il2CppName: set_sortingLayerName
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Renderer::*)(::StringW)>(&UnityEngine::Renderer::set_sortingLayerName)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "String")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Renderer*), "set_sortingLayerName", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
