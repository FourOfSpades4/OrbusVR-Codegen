...
namespace UnityEngine {
  ...
  // [NativeTypeAttribute] Offset: A6D84C
  struct jvalue/*, public ::System::ValueType*/ {
    ...
    constexpr jvalue(bool z_ = {}, uint8_t b_ = {}, ::Il2CppChar c_ = {}, int16_t s_ = {}, int i_ = {}, int64_t j_ = {}, float f_ = {}, double d_ = {}, ::System::IntPtr l_ = {}) noexcept : z{z_}, b{b_}, c{c_}, s{s_}, i{i_}, j{j_}, f{f_}, d{d_}, l{l_} {}
