...
namespace UnityEngine::Profiling::Memory::Experimental {
  ...
  class MetaData : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(::StringW) == 0x8);
    // public UnityEngine.Texture2D screenshot
    // Size: 0x8
    // Offset: 0x20
    ...
    // Get instance field reference: public UnityEngine.Texture2D screenshot
  ...
  #pragma pack(pop)
  static check_size<sizeof(MetaData), 32 + sizeof(::UnityEngine::Texture2D*)> __UnityEngine_Profiling_Memory_Experimental_MetaDataSizeCheck;
  static_assert(sizeof(MetaData) == 0x28);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
