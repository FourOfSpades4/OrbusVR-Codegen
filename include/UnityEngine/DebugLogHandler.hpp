...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: A6E50C
  class DebugLogHandler : public ::Il2CppObject/*, public ::UnityEngine::ILogHandler*/ {
    ...
    // static System.Void Internal_Log(UnityEngine.LogType level, System.String msg, UnityEngine.Object obj)
    // Offset: 0x204510C
    static void Internal_Log(::UnityEngine::LogType level, ::StringW msg, ::UnityEngine::Object* obj);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::LogType, ::StringW, ::UnityEngine::Object*)>(&UnityEngine::DebugLogHandler::Internal_Log)> {
  static const MethodInfo* get() {
    ...
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::DebugLogHandler*), "Internal_Log", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{level, msg, obj});
  }
};
