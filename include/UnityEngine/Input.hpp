...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: A6F4A8
  class Input : public ::Il2CppObject {
    ...
    // static public System.String get_inputString()
    // Offset: 0x1CBCA80
    static ::StringW get_inputString();
...
// Writing MetadataGetter for method: UnityEngine::Input::get_inputString
// Il2CppName: get_inputString
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)()>(&UnityEngine::Input::get_inputString)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Input*), "get_inputString", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
