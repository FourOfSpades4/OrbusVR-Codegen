...
namespace UnityEngine {
  ...
  class TextEditor : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(bool) == 0x1);
    // [VisibleToOtherModulesAttribute] Offset: 0xA99E5C
    ...
    // private System.Boolean PerformOperation(UnityEngine.TextEditor/TextEditOp operation)
    // Offset: 0x2105C14
    bool PerformOperation(::UnityEngine::TextEditor::TextEditOp operation);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (UnityEngine::TextEditor::*)(::UnityEngine::TextEditor::TextEditOp)>(&UnityEngine::TextEditor::PerformOperation)> {
  static const MethodInfo* get() {
    static auto* operation = &::il2cpp_utils::GetClassFromName("UnityEngine", "TextEditor/TextEditOp")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::TextEditor*), "PerformOperation", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{operation});
  }
};
