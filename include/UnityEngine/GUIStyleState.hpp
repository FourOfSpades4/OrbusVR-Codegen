...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: A990F0
  class GUIStyleState : public ::Il2CppObject {
    ...
    // public UnityEngine.Color get_textColor()
    // Offset: 0x2102104
    ...
    // Offset: 0x210159C
    static ::UnityEngine::GUIStyleState* GetGUIStyleState(::UnityEngine::GUIStyle* sourceStyle, ::System::IntPtr source);
    // private System.Void get_textColor_Injected(out UnityEngine.Color ret)
    // Offset: 0x2102130
    void get_textColor_Injected(ByRef<::UnityEngine::Color> ret);
...
// Cannot get method pointer of value based method overload from template for constructor!
// Try using FindMethod instead!
// Writing MetadataGetter for method: UnityEngine::GUIStyleState::get_textColor
// Il2CppName: get_textColor
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (UnityEngine::GUIStyleState::*)()>(&UnityEngine::GUIStyleState::get_textColor)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUIStyleState*), "get_textColor", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
...
// Writing MetadataGetter for method: UnityEngine::GUIStyleState::get_textColor_Injected
// Il2CppName: get_textColor_Injected
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::GUIStyleState::*)(ByRef<::UnityEngine::Color>)>(&UnityEngine::GUIStyleState::get_textColor_Injected)> {
  static const MethodInfo* get() {
    static auto* ret = &::il2cpp_utils::GetClassFromName("UnityEngine", "Color")->this_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUIStyleState*), "get_textColor_Injected", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{ret});
  }
};
