...
namespace UnityEngine::Playables {
  ...
  // [RequiredByNativeCodeAttribute] Offset: A71B70
  struct PlayableOutput/*, public ::System::ValueType, public ::UnityEngine::Playables::IPlayableOutput, public ::System::IEquatable_1<::UnityEngine::Playables::PlayableOutput>*/ {
    ...
    bool IsPlayableOutputOfType() {
      static_assert(std::is_convertible_v<T, ::System::ValueType*> && std::is_convertible_v<std::remove_pointer_t<T>, ::UnityEngine::Playables::IPlayableOutput>);
...
// Writing MetadataGetter for method: UnityEngine::Playables::PlayableOutput::GetPlayableOutputType
// Il2CppName: GetPlayableOutputType
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Type* (UnityEngine::Playables::PlayableOutput::*)()>(&UnityEngine::Playables::PlayableOutput::GetPlayableOutputType)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Playables::PlayableOutput), "GetPlayableOutputType", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
