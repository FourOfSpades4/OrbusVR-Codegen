...
namespace UnityEngine::Playables {
  ...
  class PlayableOutputExtensions : public ::Il2CppObject {
    ...
    static void SetReferenceObject(U output, ::UnityEngine::Object* value) {
      static_assert(std::is_convertible_v<U, ::System::ValueType*> && std::is_convertible_v<std::remove_pointer_t<U>, ::UnityEngine::Playables::IPlayableOutput>);
    ...
    static void SetSourcePlayable(U output, V value) {
      static_assert(std::is_convertible_v<U, ::System::ValueType*> && std::is_convertible_v<std::remove_pointer_t<U>, ::UnityEngine::Playables::IPlayableOutput>);
      static_assert(std::is_convertible_v<V, ::System::ValueType*> && std::is_convertible_v<std::remove_pointer_t<V>, ::UnityEngine::Playables::IPlayable>);
    ...
    // static public System.Void SetSourceOutputPort(U output, System.Int32 value)
    // Offset: 0xFFFFFFFFFFFFFFFF
    template<class U>
    static void SetSourceOutputPort(U output, int value) {
      static_assert(std::is_convertible_v<U, ::System::ValueType*> && std::is_convertible_v<std::remove_pointer_t<U>, ::UnityEngine::Playables::IPlayableOutput>);
      static auto ___internal__logger = ::Logger::get().WithContext("::UnityEngine::Playables::PlayableOutputExtensions::SetSourceOutputPort");
      static auto* ___internal__method = THROW_UNLESS((::il2cpp_utils::FindMethod("UnityEngine.Playables", "PlayableOutputExtensions", "SetSourceOutputPort", std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<U>::get()}, ::std::vector<const Il2CppType*>{::il2cpp_utils::ExtractType(output), ::il2cpp_utils::ExtractType(value)})));
      static auto* ___generic__method = THROW_UNLESS(::il2cpp_utils::MakeGenericMethod(___internal__method, std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<U>::get()}));
      ::il2cpp_utils::RunMethodRethrow<void, false>(static_cast<Il2CppObject*>(nullptr), ___generic__method, output, value);
    }
...
// Cannot write MetadataGetter for generic methods!
// Writing MetadataGetter for method: UnityEngine::Playables::PlayableOutputExtensions::SetSourceOutputPort
