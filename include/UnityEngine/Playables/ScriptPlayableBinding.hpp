...
namespace UnityEngine::Playables {
  ...
  class ScriptPlayableBinding : public ::Il2CppObject {
    ...
    static ::UnityEngine::Playables::PlayableBinding::CreateOutputMethod* _get_$$f__mg$cache0();
    // Set static field: static private UnityEngine.Playables.PlayableBinding/CreateOutputMethod <>f__mg$cache0
    static void _set_$$f__mg$cache0(::UnityEngine::Playables::PlayableBinding::CreateOutputMethod* value);
