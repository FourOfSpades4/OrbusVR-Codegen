...
namespace UnityEngine::Playables {
  ...
  // [RequiredByNativeCodeAttribute] Offset: A71950
  struct Playable/*, public ::System::ValueType, public ::UnityEngine::Playables::IPlayable, public ::System::IEquatable_1<::UnityEngine::Playables::Playable>*/ {
    ...
    bool IsPlayableOfType() {
      static_assert(std::is_convertible_v<T, ::System::ValueType*> && std::is_convertible_v<std::remove_pointer_t<T>, ::UnityEngine::Playables::IPlayable>);
