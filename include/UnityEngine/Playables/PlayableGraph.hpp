...
namespace UnityEngine::Playables {
  ...
  // [NativeHeaderAttribute] Offset: A71A24
  // [NativeHeaderAttribute] Offset: A71A24
  // [NativeHeaderAttribute] Offset: A71A24
  // [NativeHeaderAttribute] Offset: A71A24
  // [UsedByNativeCodeAttribute] Offset: A71A24
  struct PlayableGraph/*, public ::System::ValueType*/ {
    ...
    bool Connect(U source, int sourceOutputPort, V destination, int destinationInputPort) {
      static_assert(std::is_convertible_v<U, ::System::ValueType*> && std::is_convertible_v<std::remove_pointer_t<U>, ::UnityEngine::Playables::IPlayable>);
