...
namespace UnityEngine::XR {
  ...
  // [StaticAccessorAttribute] Offset: A8EA74
  // [NativeHeaderAttribute] Offset: A8EA74
  // [NativeConditionalAttribute] Offset: A8EA74
  // [RequiredByNativeCodeAttribute] Offset: A8EA74
