...
namespace UnityEngine {
  ...
  // [RequiredByNativeCodeAttribute] Offset: A9FA7C
  class Collision2D : public ::Il2CppObject {
    ...
    // Field size check
    static_assert(sizeof(int) == 0x4);
    // UnityEngine.ContactPoint2D[] m_RecycledContacts
    // Size: 0x8
    // Offset: 0x30
    ::ArrayW<::UnityEngine::ContactPoint2D> m_RecycledContacts;
    // Field size check
    ...
    // Get instance field reference: UnityEngine.ContactPoint2D[] m_RecycledContacts
    [[deprecated("Use field access instead!")]] ::ArrayW<::UnityEngine::ContactPoint2D>& dyn_m_RecycledContacts();
