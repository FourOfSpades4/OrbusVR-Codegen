...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Experimental::Animations::AnimationStream, "UnityEngine.Experimental.Animations", "AnimationStream");
// Type namespace: UnityEngine.Experimental.Animations
namespace UnityEngine::Experimental::Animations {
  // Size: 0x38
  #pragma pack(push, 1)
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: UnityEngine.Experimental.Animations.AnimationStream
  // [TokenAttribute] Offset: FFFFFFFF
  // [RequiredByNativeCodeAttribute] Offset: A92CF4
  // [NativeHeaderAttribute] Offset: A92CF4
  // [NativeHeaderAttribute] Offset: A92CF4
  ...
  #pragma pack(pop)
  static check_size<sizeof(AnimationStream), 48 + sizeof(::System::IntPtr)> __UnityEngine_Experimental_Animations_AnimationStreamSizeCheck;
