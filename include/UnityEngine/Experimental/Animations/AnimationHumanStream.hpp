...
DEFINE_IL2CPP_ARG_TYPE(::UnityEngine::Experimental::Animations::AnimationHumanStream, "UnityEngine.Experimental.Animations", "AnimationHumanStream");
// Type namespace: UnityEngine.Experimental.Animations
namespace UnityEngine::Experimental::Animations {
  // Size: 0x8
  #pragma pack(push, 1)
  // WARNING Layout: Sequential may not be correctly taken into account!
  // Autogenerated type: UnityEngine.Experimental.Animations.AnimationHumanStream
  // [TokenAttribute] Offset: FFFFFFFF
  // [NativeHeaderAttribute] Offset: A92530
  // [RequiredByNativeCodeAttribute] Offset: A92530
  // [NativeHeaderAttribute] Offset: A92530
  ...
  #pragma pack(pop)
  static check_size<sizeof(AnimationHumanStream), 0 + sizeof(::System::IntPtr)> __UnityEngine_Experimental_Animations_AnimationHumanStreamSizeCheck;
