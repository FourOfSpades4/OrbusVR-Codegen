...
namespace UnityEngine::Experimental::Rendering {
  ...
  // [RequiredByNativeCodeAttribute] Offset: A71388
  class ScriptableRuntimeReflectionSystemWrapper : public ::Il2CppObject {
    public:
    public:
    // [DebuggerBrowsableAttribute] Offset: 0xA73ED4
    // [CompilerGeneratedAttribute] Offset: 0xA73ED4
    ...
    // private System.Void Internal_ScriptableRuntimeReflectionSystemWrapper_TickRealtimeProbes(System.IntPtr result)
    // Offset: 0x1CB7268
    void Internal_ScriptableRuntimeReflectionSystemWrapper_TickRealtimeProbes(::System::IntPtr result);
...
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::*)(::System::IntPtr)>(&UnityEngine::Experimental::Rendering::ScriptableRuntimeReflectionSystemWrapper::Internal_ScriptableRuntimeReflectionSystemWrapper_TickRealtimeProbes)> {
  static const MethodInfo* get() {
    static auto* result = &::il2cpp_utils::GetClassFromName("System", "IntPtr")->byval_arg;
