...
namespace UnityEngine::Experimental::TerrainAPI {
  ...
  class TerrainUtility : public ::Il2CppObject {
    ...
    class TerrainGroups;
    // Nested type: ::UnityEngine::Experimental::TerrainAPI::TerrainUtility::$CollectTerrains$c__AnonStorey1
    class $CollectTerrains$c__AnonStorey1;
    // Nested type: ::UnityEngine::Experimental::TerrainAPI::TerrainUtility::$CollectTerrains$c__AnonStorey0
    class $CollectTerrains$c__AnonStorey0;
