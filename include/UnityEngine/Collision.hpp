...
namespace UnityEngine {
  ...
  // [RequiredByNativeCodeAttribute] Offset: A81004
  class Collision : public ::Il2CppObject {
    ...
    // Padding between fields: m_ContactCount and: m_RecycledContacts
    char __padding4[0x4] = {};
    // UnityEngine.ContactPoint[] m_RecycledContacts
    // Size: 0x8
    // Offset: 0x40
    ::ArrayW<::UnityEngine::ContactPoint> m_RecycledContacts;
    // Field size check
    ...
    // Get instance field reference: UnityEngine.ContactPoint[] m_RecycledContacts
    [[deprecated("Use field access instead!")]] ::ArrayW<::UnityEngine::ContactPoint>& dyn_m_RecycledContacts();
