...
namespace UnityEngine {
  ...
  // [StaticAccessorAttribute] Offset: A70F80
  // [NativeHeaderAttribute] Offset: A70F80
  class Time : public ::Il2CppObject {
    ...
    // static public System.Void set_maximumParticleDeltaTime(System.Single value)
    // Offset: 0x1F9F600
    static void set_maximumParticleDeltaTime(float value);
...
// Writing MetadataGetter for method: UnityEngine::Time::get_maximumParticleDeltaTime
// Il2CppName: get_maximumParticleDeltaTime
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float (*)()>(&UnityEngine::Time::get_maximumParticleDeltaTime)> {
  static const MethodInfo* get() {
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Time*), "get_maximumParticleDeltaTime", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{});
  }
};
// Writing MetadataGetter for method: UnityEngine::Time::set_maximumParticleDeltaTime
// Il2CppName: set_maximumParticleDeltaTime
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(float)>(&UnityEngine::Time::set_maximumParticleDeltaTime)> {
  static const MethodInfo* get() {
    static auto* value = &::il2cpp_utils::GetClassFromName("System", "Single")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::Time*), "set_maximumParticleDeltaTime", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{value});
  }
};
