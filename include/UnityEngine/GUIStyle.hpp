...
namespace UnityEngine {
  ...
  // [NativeHeaderAttribute] Offset: A99128
  // [NativeHeaderAttribute] Offset: A99128
  // [RequiredByNativeCodeAttribute] Offset: A99128
  class GUIStyle : public ::Il2CppObject {
    ...
    // System.Void DrawWithTextSelection(UnityEngine.Rect position, UnityEngine.GUIContent content, System.Boolean isActive, System.Boolean hasKeyboardFocus, System.Int32 firstSelectedCharacter, System.Int32 lastSelectedCharacter, System.Boolean drawSelectionAsComposition)
    // Offset: 0x2101C58
    void DrawWithTextSelection(::UnityEngine::Rect position, ::UnityEngine::GUIContent* content, bool isActive, bool hasKeyboardFocus, int firstSelectedCharacter, int lastSelectedCharacter, bool drawSelectionAsComposition);
  ...
  #pragma pack(pop)
  static check_size<sizeof(GUIStyle), 112 + sizeof(::UnityEngine::RectOffset*)> __UnityEngine_GUIStyleSizeCheck;
  static_assert(sizeof(GUIStyle) == 0x78);
}
#include "beatsaber-hook/shared/utils/il2cpp-utils-methods.hpp"
...
// Il2CppName: DrawWithTextSelection
template<>
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::GUIStyle::*)(::UnityEngine::Rect, ::UnityEngine::GUIContent*, bool, bool, int, int, bool)>(&UnityEngine::GUIStyle::DrawWithTextSelection)> {
  static const MethodInfo* get() {
    static auto* position = &::il2cpp_utils::GetClassFromName("UnityEngine", "Rect")->byval_arg;
    static auto* content = &::il2cpp_utils::GetClassFromName("UnityEngine", "GUIContent")->byval_arg;
    static auto* isActive = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    ...
    static auto* lastSelectedCharacter = &::il2cpp_utils::GetClassFromName("System", "Int32")->byval_arg;
    static auto* drawSelectionAsComposition = &::il2cpp_utils::GetClassFromName("System", "Boolean")->byval_arg;
    return ::il2cpp_utils::FindMethod(classof(UnityEngine::GUIStyle*), "DrawWithTextSelection", std::vector<Il2CppClass*>(), ::std::vector<const Il2CppType*>{position, content, isActive, hasKeyboardFocus, firstSelectedCharacter, lastSelectedCharacter, drawSelectionAsComposition});
  }
};
// Writing MetadataGetter for method: UnityEngine::GUIStyle::DrawWithTextSelection
// Il2CppName: DrawWithTextSelection
