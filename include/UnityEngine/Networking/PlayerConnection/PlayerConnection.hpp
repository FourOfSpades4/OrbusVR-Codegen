...
namespace UnityEngine::Networking::PlayerConnection {
  ...
  class PlayerConnection : public ::UnityEngine::ScriptableObject/*, public ::UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection*/ {
    public:
    // Nested type: ::UnityEngine::Networking::PlayerConnection::PlayerConnection::$Register$c__AnonStorey0
    class $Register$c__AnonStorey0;
    // Nested type: ::UnityEngine::Networking::PlayerConnection::PlayerConnection::$Unregister$c__AnonStorey1
    class $Unregister$c__AnonStorey1;
    // Nested type: ::UnityEngine::Networking::PlayerConnection::PlayerConnection::$BlockUntilRecvMsg$c__AnonStorey2
    class $BlockUntilRecvMsg$c__AnonStorey2;
    public:
