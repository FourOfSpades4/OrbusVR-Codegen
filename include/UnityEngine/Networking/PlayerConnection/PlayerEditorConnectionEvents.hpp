...
namespace UnityEngine::Networking::PlayerConnection {
  ...
  class PlayerEditorConnectionEvents : public ::Il2CppObject {
    ...
    // Nested type: ::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents::$InvokeMessageIdSubscribers$c__AnonStorey0
    class $InvokeMessageIdSubscribers$c__AnonStorey0;
    // Nested type: ::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents::$AddAndCreate$c__AnonStorey1
    class $AddAndCreate$c__AnonStorey1;
    // Nested type: ::UnityEngine::Networking::PlayerConnection::PlayerEditorConnectionEvents::$UnregisterManagedCallback$c__AnonStorey2
    class $UnregisterManagedCallback$c__AnonStorey2;
    public:
