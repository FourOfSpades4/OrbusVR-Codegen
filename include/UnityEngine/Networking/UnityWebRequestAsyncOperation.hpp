...
namespace UnityEngine::Networking {
  ...
  // [NativeHeaderAttribute] Offset: A8CF54
  // [NativeHeaderAttribute] Offset: A8CF54
  // [UsedByNativeCodeAttribute] Offset: A8CF54
  class UnityWebRequestAsyncOperation : public ::UnityEngine::AsyncOperation {
    public:
    public:
    // [CompilerGeneratedAttribute] Offset: 0xA8D18C
    // [DebuggerBrowsableAttribute] Offset: 0xA8D18C
